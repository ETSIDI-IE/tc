...
\begin{enumerate}
\item El generador equivalente de Thévenin respecto de A y B,  \(\overline{\epsilon_{th}}\).
\item La impedancia equivalente de Thévenin respecto de A y B, \(\overline{Z_{th}}\).
