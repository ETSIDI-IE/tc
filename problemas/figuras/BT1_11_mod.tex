...
\coordinate (A) at (0,5);
  \draw
   ...
   (0,5) to [short,-] (-3,5)
   %(-3,5) to [C, l=$1\mu$F, i^<=$I_9$] (-3,0)
   (-3,0) to [short,-] (0,0)
   (0,0) to [short, -] (0,-3) %node[ground] {}
   ...
   %(D) to [C, l=$2\mu$F, i=$I_0^1$] (3,-3)
   (3,-3) to [short,-] (6,-3)
   (0,-3) to [short, -] (6,-3) %node[ground] {}
   %(6,0) to [C, l=$3\mu$F, i=$I_1^1$] (6,-3)
   (6,-3) to [short,-] (9,-3);
   %(9,0) to [C, l=$4\mu$F, i=$I_2^1$] (9,-3);
