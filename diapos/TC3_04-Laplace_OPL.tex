...
\label{sec:orge595026}
\begin{frame}[label={sec:orgee73aa3}]{Resistencia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
  v(t) = R i(t)  
...
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Resistencia_Laplace.pdf}
\end{center}
\end{column}
\end{columns}
\end{frame}

\begin{frame}[label={sec:org2fd08a1}]{Bobina}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
  v(t) = L \diff{i(t)}{t}
...
\begin{frame}[label={sec:org0810fcf}]{Condensador}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
  i(t) = C \diff{v(t)}{t}
...
\begin{frame}[label={sec:org24341f7}]{Ejemplo (examen 2018-19)}
\begin{columns}
...
\label{sec:orgf2d716b}

\begin{frame}[label={sec:org61aedc4}]{Función de Transferencia}
\begin{center}
...
\begin{frame}[label={sec:org70b213e}]{Ejemplo Diagrama Polos y Ceros}
\begin{columns}
\begin{column}{0.3\columnwidth}
\[
...
\begin{frame}[label={sec:org8ab5cb9}]{Significado Diagrama Polos y Ceros}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PoleZero.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org175bc09}]{Ejemplo Polos y Respuesta Natural}
\[
  y_n(t) = A_1 e^{-3t} + A_2 e^{-0.1 t} + A_3 e^{-t} \sin(2 t + \theta)
\]

\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Ejemplo_Polos.pdf}
\end{center}
\end{frame}


\section{Ejercicios Recomendados}
\label{sec:org00ee4f1}

\begin{frame}[label={sec:orge2a3c52}]{Ejercicios}
\begin{itemize}
