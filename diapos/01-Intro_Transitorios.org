...
- La tensión en una condensador no puede variar de forma abrupta (implica corriente infinita).
#+BEGIN_EXPORT latex
\[
u_C(0^-) = u_C(0^+)
\]
...
*** (Sep 2010) El interruptor lleva en la posición (1) desde un tiempo infinito, pasa a la posición (2)
