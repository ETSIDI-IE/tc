...
\section{Bobina}
\label{sec:orgf91a5a9}

\begin{frame}[label={sec:org6d3b15a}]{Ley de Ampere}
...
\begin{frame}[label={sec:orgbedffa2}]{Ley de Faraday}
...
\begin{frame}[label={sec:orgaebf7b2}]{Bobina}
...
\begin{frame}[label={sec:org234519d}]{Bobina}
...
\label{sec:org5982956}
\begin{frame}[label={sec:orgb8abf9f},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/acoplamientoTikz.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5b204a1},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org447890a},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgdb82d34}]{Coeficientes de autoinducción e inducción mutua}
\begin{columns}
...
\begin{frame}[label={sec:org69bd0a7}]{Coeficiente de acoplamiento magnético}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\begin{frame}[label={sec:orgd716e9f}]{Coeficiente de inducción mutua}
...
\begin{frame}[label={sec:org16c4b1e}]{Resumen}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{align*}
  L_1 &= N_1 \frac{\phi_{11}}{i_1}\\
...
\label{sec:orgd3089c2}
\begin{frame}[label={sec:org73b8c88}]{Flujos del mismo sentido}
\begin{center}
...
\begin{frame}[label={sec:org38ed6c9}]{Flujos del mismo sentido: representación circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgda2d962}]{Flujos del mismo sentido: representación circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org8f9a2cc}]{Flujos contrapuestos}
\begin{center}
...
\begin{frame}[label={sec:org889f0d8}]{Flujos contrapuestos: representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3b2f21e}]{Flujos contrapuestos: representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org51f53cd}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org9e3d24e}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org232228a}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orga886bb0}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
