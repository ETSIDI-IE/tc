...
\section{Bobina}
\label{sec:org9225d62}

\begin{frame}[label={sec:orgdcd4578}]{Ley de Ampere}
...
\begin{frame}[label={sec:orga5481ae}]{Ley de Faraday}
...
\begin{frame}[label={sec:org577621f}]{Bobina}
...
\begin{frame}[label={sec:org3b2b40a}]{Bobina}
...
\label{sec:org5035bbb}
\begin{frame}[label={sec:orgddd1324},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/acoplamientoTikz.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org676b0da},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org5491361},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org82afbff},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
...
\begin{frame}[label={sec:org3a0c317}]{Coeficiente de acoplamiento magnético}
\begin{center}
...
\label{sec:org00130f2}
\begin{frame}[label={sec:org1ae6df6}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org9a09e53}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgbb9bbd6}]{Flujos contrapuestos}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgb8bdc8a}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
induce una tensión positiva en el otro terminal con punto.
\end{frame}
\begin{frame}[label={sec:org8f50e77}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\begin{frame}[label={sec:org4d63d8a}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb6deb33}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd21d1fc}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org4978a64}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
