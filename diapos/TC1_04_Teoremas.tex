...
\section{Generadores}
\label{sec:orgcea69af}

\begin{frame}[label={sec:orgf96bba9}]{Generadores de Tensión y Corriente}
\begin{columns}
...
\begin{frame}[label={sec:orgb4b2a5f}]{Generador Real}
...
\begin{frame}[label={sec:orgcd03e6d}]{Equivalencia de fuentes}
...
\begin{frame}[label={sec:org21fec3b}]{Generadores de Tensión dependientes \ldots{}}
\begin{columns}
\begin{column}{0.5\columnwidth}
  \begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9c42b8a}]{Generadores de Corriente dependientes \ldots{}}
\begin{columns}
\begin{column}{0.5\columnwidth}
 \begin{center}
...
\label{sec:org23e91e2}

\begin{frame}[label={sec:orgd0cb0ff}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org967d3f4}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org1bc30b6}]{Análisis de un circuito mediante proporcionalidad}
...
\begin{frame}[label={sec:org06a27e3}]{Análisis de un circuito mediante proporcionalidad}
...
\begin{frame}[label={sec:org487fddf}]{Aditividad o Superposición}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgea9531f}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org60f57bc}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org2e427af}]{Principio de superposición y Potencia}
\begin{itemize}
...
\label{sec:org76cdeeb}

\begin{frame}[label={sec:org8f8a409}]{Thévenin}
...
\begin{frame}[label={sec:orgbbcd202}]{Norton}
...
\begin{frame}[label={sec:org174d9e6}]{Cálculo del equivalente de Thévenin}
\begin{center}
...
\begin{frame}[label={sec:orgee7e667}]{Cálculo del equivalente de Norton}
\begin{center}
...
\begin{frame}[label={sec:orgc596957}]{Cálculo de Thévenin/Norton}
\begin{block}{Observaciones}
\begin{itemize}
...
\label{sec:org96c39d8}

\begin{frame}[label={sec:org9d40083}]{Planteamiento}
...
\begin{frame}[label={sec:org2fd9ec1}]{Ecuaciones}
...
\begin{frame}[label={sec:org2ee872b}]{Reactancia}
...
\begin{frame}[label={sec:org9845671}]{Resistencia}
...
\begin{frame}[label={sec:orgc367731}]{Impedancia de carga}
...
\begin{frame}[label={sec:org9c941f6}]{Máxima potencia disponible}
