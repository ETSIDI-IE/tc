...
\begin{frame}[label={sec:org3bf395e}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgfa3e2ad}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org823ef57}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:orgc99dd4a}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org0765674}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org355140f}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orgdaae666}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:orgcb25d7d}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\begin{frame}[label={sec:org8a99944}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org806c2a2}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org6815a97}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org470cc10}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgd973078}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orga872314}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org6e40c78}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgeaae9fb}]{Generador Real}
...
\begin{frame}[label={sec:orgd66df3b}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org63539c8}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgc1c8ee3}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4c598f7}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2d06ff0}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org2238230}]{Conexión en paralelo de inductancias}
\begin{center}
...
\label{sec:org94bc91e}
\begin{frame}[label={sec:org101c8b8}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:org9bb5f64}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org53df350}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:org31d3190}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:org9b7daba}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:org0a727ca}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:orgb232948}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:orgb79c1e6}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:orge317a0b}]{Factor de potencia}
...
\begin{frame}[label={sec:orgbedfa4d}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org3d9669c}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org8945528}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:orgbfef1e5}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org088f894}]{Cálculo de la Capacidad}
\begin{center}
...
\begin{frame}[label={sec:org6ac1273}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd128510}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6a8bc52}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orga859baa}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org47555e0}]{Receptor en Triángulo Desequilibrado}
\begin{center}
...
\begin{frame}[label={sec:org3043c5a}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgb1ca30c}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgc1dff09}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org1a33aa1}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org9bebf71}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgee6e24c}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfde4090}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
