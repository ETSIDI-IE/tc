...
\section{Generadores}
\label{sec:org3be08b9}
\begin{frame}[label={sec:org991d6d0}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgd99d9ab}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org04dfaa6}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org3fca8a6}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgd92f462}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orge4556b3}
\begin{frame}[label={sec:org5af5460}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org1657b9e}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orged67713}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org456afa2}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4280794}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org363c894}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdc8e643}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:org871b9bc}]{Método del desplazamiento del neutro}
\end{frame}
\begin{frame}[label={sec:orgb5c9a66}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbee3679}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org3dbab9d}

\begin{frame}[label={sec:org5ec9f4b}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orga541f8b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgb313702}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org575e7bf}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:orgdde4e92}

\begin{frame}[label={sec:org7f29bfc}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge35b4e3}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org42612b5}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgc962b22}
\begin{frame}[label={sec:org4ab28fc}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgca6e4dd}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgbea9c3d}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge8fb05e},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:orgd633cfc},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org233a571}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgac976c4}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org00c0fdf}]{Medida de la potencia con receptor desequilibrado}
\end{frame}

\section{Equivalentes}
\label{sec:org31bf1b7}

\begin{frame}[label={sec:org0930314}]{Equivalente de un motor trifásico}
\end{frame}

\begin{frame}[label={sec:orgd10555e}]{Equivalencia de fuentes}
Estrella -> Triángulo
\end{frame}
\begin{frame}[label={sec:org9b5ae14}]{Equivalencia de fuentes}
Triángulo -> Estrella
\end{frame}
\begin{frame}[label={sec:orgd21274a}]{Estudio generalizado de los sistemas trifásicos}
\end{frame}
\end{document}