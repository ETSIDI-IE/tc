...
\label{sec:orge1b1e84}
\begin{frame}[label={sec:org4872654}]{Clasificación}
\begin{itemize}
...
\begin{frame}[label={sec:orgc272b93}]{Generador Ideal}
\begin{columns}
...
\begin{frame}[label={sec:org6a20b9f}]{Generador Real CC}
...
\begin{frame}[label={sec:org2b43baa}]{Generador Real AC}
...
\begin{frame}[label={sec:orgc0d07c9}]{Generadores Dependientes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org197bff9}]{Generadores Dependientes}
...
\label{sec:org8e24131}

\begin{frame}[label={sec:orgb785180}]{Ecuación del generador CC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2bdaa93}]{Ecuación del generador AC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/FuenteTensionReal.pdf}
...
\begin{frame}[label={sec:orgc339b8c}]{Diagramas Tensión - Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
Fuente de tensión
\begin{center}
...
\begin{frame}[label={sec:org68c959d}]{Potencia y rendimiento de una fuente}
\begin{columns}
...
\begin{frame}[label={sec:org3500976}]{Potencia de una fuente AC}
...
\begin{frame}[label={sec:orgf46c335}]{Máxima potencia de una fuente AC}
...
\begin{frame}[label={sec:org2472832}]{Máxima potencia de una fuente AC}
...
\begin{frame}[label={sec:org49a0a50}]{Máxima potencia de una fuente AC}
...
\label{sec:org5e63aa2}
\begin{frame}[label={sec:orgb06ba75}]{Equivalencia de fuentes}
...
\begin{frame}[label={sec:org42ff8e9}]{Conexión en serie de generadores}
\begin{block}{Generadores de Tensión}
...
\begin{frame}[label={sec:org39aaa10}]{Conexión en paralelo de generadores}
\begin{block}{Generadores de Tensión}
\begin{itemize}
...
\begin{frame}[label={sec:orgdd3feca}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org408eedd}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org7a74527}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge6c0362}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9525709}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/ModificacionGeometria_FuenteTension.pdf}
