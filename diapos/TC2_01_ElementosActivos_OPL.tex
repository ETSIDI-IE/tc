...
\label{sec:org3f652ff}
\begin{frame}[label={sec:orgcfa5c97}]{Clasificación}
\begin{itemize}
...
\begin{frame}[label={sec:org41feb40}]{Generador Ideal}
\begin{columns}
...
\begin{frame}[label={sec:orgd35a336}]{Generador Real CC}
...
\begin{frame}[label={sec:orgc194bf8}]{Generador Real AC}
...
\begin{frame}[label={sec:org622bf38}]{Generadores Dependientes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org38c7331}]{Generadores Dependientes}
...
\label{sec:org2b4c554}

\begin{frame}[label={sec:org178c292}]{Ecuación del generador CC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb2ffebc}]{Ecuación del generador AC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/FuenteTensionReal.pdf}
...
\begin{frame}[label={sec:org54d010f}]{Diagramas Tensión - Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
Fuente de tensión
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org614469e}]{Potencia y rendimiento de una fuente}
\begin{columns}
...
\begin{frame}[label={sec:org67a726a}]{Potencia y rendimiento de una fuente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf37b877}]{Potencia de una fuente AC}
...
\begin{frame}[label={sec:orgb9afef8}]{Máxima potencia de una fuente AC}
...
\label{sec:org1ce24e7}
\begin{frame}[label={sec:org6e58e15}]{Equivalencia de fuentes}
...
\begin{frame}[label={sec:org6bb33e5}]{Conexión en serie de generadores}
\begin{block}{Generadores de Tensión}
...
\begin{frame}[label={sec:org4bdd64e}]{Conexión en paralelo de generadores}
\begin{block}{Generadores de Tensión}
\begin{itemize}
...
\begin{frame}[label={sec:org6b8be59}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org579102f}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org2fdaa12}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org670baed}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6a241e1}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/ModificacionGeometria_FuenteTension.pdf}
