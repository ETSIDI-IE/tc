...
\label{sec:org2e1f105}
\begin{frame}[label={sec:orgf67a401}]{Clasificación}
\begin{itemize}
...
\begin{frame}[label={sec:org245e168}]{Generador Ideal}
\begin{columns}
...
\begin{frame}[label={sec:org8dcdbcb}]{Generador Real CC}
...
\begin{frame}[label={sec:org0e0489e}]{Generador Real AC}
...
\begin{frame}[label={sec:orgb69b566}]{Generadores Dependientes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org59c2d25}]{Generadores Dependientes}
...
\label{sec:orgbd01b20}

\begin{frame}[label={sec:orgc6a54ee}]{Ecuación del generador CC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge18aa25}]{Ecuación del generador AC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/FuenteTensionReal.pdf}
...
\begin{frame}[label={sec:org7165de0}]{Diagramas Tensión - Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
Fuente de tensión
\begin{center}
...
\begin{frame}[label={sec:orgea23fb7}]{Potencia y rendimiento de una fuente}
\begin{columns}
...
\begin{frame}[label={sec:orge8820a7}]{Potencia de una fuente AC}
...
\begin{frame}[label={sec:orgbb10886}]{Máxima potencia de una fuente AC}
...
\begin{frame}[label={sec:orgc6e9c25}]{Máxima potencia de una fuente AC}
...
\begin{frame}[label={sec:orgee1fe46}]{Máxima potencia de una fuente AC}
...
\label{sec:orgd78b72b}
\begin{frame}[label={sec:org0fd58c1}]{Equivalencia de fuentes}
...
\begin{frame}[label={sec:orgcb9f9a6}]{Conexión en serie de generadores}
\begin{block}{Generadores de Tensión}
...
\begin{frame}[label={sec:org731e682}]{Conexión en paralelo de generadores}
\begin{block}{Generadores de Tensión}
\begin{itemize}
...
\begin{frame}[label={sec:org99920ed}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org8ab3186}]{Fuentes dominantes}
...
\begin{frame}[label={sec:org4d29066}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgded89f0}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org03ffc97}]{Modificación de la geometría de un circuito}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/ModificacionGeometria_FuenteTension.pdf}
