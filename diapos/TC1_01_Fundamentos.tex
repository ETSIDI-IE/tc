...
\begin{frame}[label={sec:org1f68797}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org3315b4b}]{Sistemas lineales}
...
\begin{frame}[label={sec:org008bf4e}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:orgb6917d1}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf2b0de0}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org29dab3e}
\begin{frame}[label={sec:org8ea1a2b}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org645bbe6}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org0eb49bf}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org8e696d4}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org34697ba}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org74edfac}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org294b30f}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgfeb7d3f}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org1d6f7a7}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org7a2f5b7}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org101d945}

\subsection{Elementos Pasivos}
\label{sec:org6dafbd6}
\begin{frame}[label={sec:orgbdfb952}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org7f201b5}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orga862c69}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orgddc1bb3}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:orgf673257}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgb7e1408}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org60f86bc}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgefd8e14}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org9d1e7e4}

\begin{frame}[label={sec:orgafd217d}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9e1276a}]{Generador Real}
...
\label{sec:orgea8c879}

\subsection{Definiciones}
\label{sec:orgacc58f0}
\begin{frame}[label={sec:orgb915f1c}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org8a557df}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org2573021}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgec1e7f6}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org3d7c8b1}]{Balance de Tensiones}
\begin{center}
...
\label{sec:org8d575ff}

\begin{frame}[label={sec:org2a0d8fd}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orge50ec34}]{Equivalencia de Fuentes}
...
\label{sec:org701153e}

\begin{frame}[label={sec:org06105e8}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf1dd66b}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgdbf0d70}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org34384ad}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga364598}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgb2303f9}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgc827182}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaf73a1c}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org81964c6}]{Conductancia}
...
\begin{frame}[label={sec:org61703d9}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:org3a79d18}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:orgb35c740}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf098956}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9f2e85d}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb6e0471}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5a36229}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org54407a2}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org899a11b}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\begin{frame}[label={sec:orga49cddc}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org3214da0}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
