...
\begin{frame}[label={sec:org1f5e566}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org1234a84}]{Sistemas lineales}
...
\begin{frame}[label={sec:org044fbd4}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org14950c2}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2ec8a18}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org22e1042}
\begin{frame}[label={sec:orgd4a38d8}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org1c28b95}]{La trayectoria no importa}
...
\begin{frame}[label={sec:orgbcf85aa}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org74b1b79}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org7032561}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:orgcaeecf0}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org867bc45}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org8850b11}

\subsection{Elementos Pasivos}
\label{sec:org79b9a34}
\begin{frame}[label={sec:orgbe8fe16}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org6fc0493}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc1a26e1}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org15a2a29}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgeb6b50f}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org6391268}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org419382a}

\begin{frame}[label={sec:org9a1a64f}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org93612f8}]{Generador Real}
...
\label{sec:org15ec073}

\subsection{Definiciones}
\label{sec:orge38bf3b}
\begin{frame}[label={sec:orga8cf4c6}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orgc582487}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgce9e032}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgaa0a533}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgae2d9e3}]{Balance de Tensiones}
\begin{center}
...
\label{sec:orge351f0d}

\begin{frame}[label={sec:orge2693e4}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org044db2b}]{Equivalencia de Fuentes}
...
\label{sec:orgee7c675}

\begin{frame}[label={sec:orga8b21d8}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgab99c33}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org5a7d5ab}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgad3f030}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgcc93617}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org88ad4c8}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orga86b43e}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org45114ae}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org65331f0}]{Conductancia}
...
\begin{frame}[label={sec:orgdb23f26}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgf35bfe1}]{Conexión en paralelo de inductancias}
\begin{center}
