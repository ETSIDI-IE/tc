...
\begin{frame}[label={sec:org140841c}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org198c8f6}]{Sistemas lineales}
...
\begin{frame}[label={sec:orgc520904}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:orgc7d5cba}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4f015ad}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:orgddb724c}
\begin{frame}[label={sec:org313d99e}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org52371c7}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org109a76b}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orge1d9dc1}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org3a683ba}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org5668e93}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org0f1fa2d}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgd4f93a6}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orgfbb5544}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org37770a8}

\subsection{Elementos Pasivos}
\label{sec:org5b401b8}
\begin{frame}[label={sec:orgdbe1a5c}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org7deffcb}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orgfb1ce6e}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org5d7cc9e}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org5944eb9}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orga767e1c}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc5009c9}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org2312525}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org3786cfe}

\begin{frame}[label={sec:org582d74e}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga499716}]{Generador Real}
...
\label{sec:org738e564}

\subsection{Definiciones}
\label{sec:org1a6340a}
\begin{frame}[label={sec:orge3be314}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orga6d5b2d}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgaf55c3e}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgcdc425d}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org91467cb}]{Balance de Tensiones}
\begin{center}
...
\label{sec:orgfb8824d}

\begin{frame}[label={sec:org5e07a06}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org1d570ad}]{Equivalencia de Fuentes}
...
\label{sec:org8632d6c}

\begin{frame}[label={sec:org1ddcf07}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org13e3a7e}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org11f4d1c}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org43341dc}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9a68f53}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3a0dedd}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd78e6d5}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcb8cf6b}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgad2d140}]{Conductancia}
...
\begin{frame}[label={sec:org7eb1be2}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgafd08de}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org569bf41}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org309b2e4}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org11fe243}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8b3cbeb}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7a16917}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4170e4f}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgc43d45f}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5449be7}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
