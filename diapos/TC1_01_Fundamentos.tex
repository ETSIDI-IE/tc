...
\begin{frame}[label={sec:orgf159858}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org9ddec50}]{Sistemas lineales}
...
\begin{frame}[label={sec:org118cf4a}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org408c0f9}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3fd5d7f}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:orgb74e31b}
\begin{frame}[label={sec:orgeead261}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orgc650d47}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org17bd994}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org53f59de}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org3e18bd1}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org67da97f}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:orgf1fd37e}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgc010959}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org7a66561}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:orgec5d0f5}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org5919d25}

\subsection{Elementos Pasivos}
\label{sec:org325890b}
\begin{frame}[label={sec:orgfb87553}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org8213ac3}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org641b6ce}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orga30211a}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org3a606c8}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org80023e8}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd16146e}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgc9eec55}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Condensador.pdf}
\end{center}
...
\label{sec:orgfc1c800}

\begin{frame}[label={sec:orgb7eddb7}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org185f66a}]{Generador Real}
...
\label{sec:orga15d90f}

\subsection{Definiciones}
\label{sec:orgf72f16c}
\begin{frame}[label={sec:orgb4b2cc6}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org8001ee8}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgf170499}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org0988f76}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org37713c0}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org53a93d5}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{../figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:orgf962b78}

\begin{frame}[label={sec:org95e6c6d}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org9606fd0}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:orgae896e1}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org3ef3bb2}

\begin{frame}[label={sec:org2201ce5}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4ffd77b}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org344994a}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0f93516}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1ec5227}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3085589}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgae2047e}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org50ca9a5}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgf39f2a6}]{Conductancia}
...
\begin{frame}[label={sec:org90c4abf}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:org70f6514}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org4902d84}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2694e79}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4bad838}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3250073}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd7eaeb4}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2639b04}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgde9a3f0}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org768c8ef}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\label{sec:orgbca9c0a}

\subsection{Método de las mallas}
\label{sec:orgfa0718a}

\begin{frame}[label={sec:org4b1cf40}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0ed9e3b}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf40391a}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\begin{frame}[label={sec:org58eb646}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb54fcdd}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:orgd662534}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgecf5cfe}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf55d53f}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org2237fe0}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org22e45f9}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org92a4832}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org9ca0a1e}]{Procedimiento}
\begin{enumerate}
...
\label{sec:org030b934}
\begin{frame}[label={sec:org0f03aa9}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org274c9c7}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org2c6beac}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6c9a177}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgeb894e3}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org62bf86b}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org1763ce9}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org58bdebc}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\label{sec:org1369990}

\subsection{Definiciones}
\label{sec:org7542512}

\begin{frame}[label={sec:orgca20371}]{Forma de Onda}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org56615a3}]{Clasificación}
...
\begin{frame}[label={sec:org2a2d557}]{Valores que definen una onda periódica}
...
\begin{frame}[label={sec:orge491544}]{Valores que definen una onda periódica}
\begin{itemize}
...
\label{sec:orgdb3f98b}
\begin{frame}[label={sec:orge4a1366}]{Escalón}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8f03681}]{Escalón desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org99869e5}]{Pulso}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge057778}]{Pulso desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga519a80}]{Rampa}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2c6c1e3}]{Rampa desplazada}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org79242f8}]{Triangular}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org54c8362}]{Triangular desplazada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\label{sec:org553d057}


\begin{frame}[label={sec:orga459072}]{Tren de Pulsos Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/cuadrada_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf88803b}]{Tren de Pulsos Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/cuadrada0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbcd3d13}]{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7236869}]{Onda Triangular Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org46db52a}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:org25586c3}]{Valor medio y valor eficaz}
\begin{block}{Valor medio}
\[
