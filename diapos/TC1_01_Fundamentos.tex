...
\begin{frame}[label={sec:org8d202ce}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org20be5f1}]{Sistemas lineales}
...
\label{sec:orgb154596}
\begin{frame}[label={sec:org7873ede}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org3bfa361}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org8746b14}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org87342c1}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org25afa01}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org73a44e4}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org07293e5}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orga8f0c0c}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orga8b17fb}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:orgbda2303}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgc315289}

\subsection{Elementos Pasivos}
\label{sec:org5da90a1}
\begin{frame}[label={sec:org4eef169}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org93e1a91}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org32e71aa}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org9b79b1b}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org62c3795}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgb90bd57}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orga2eb8c8}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\begin{frame}[label={sec:org4d0b229}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf8795df}]{Generador Real}
...
\label{sec:orgf78f0da}

\subsection{Definiciones}
\label{sec:org7166c09}
\begin{frame}[label={sec:orgce3e8e7}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org265e10c}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org62cc0b9}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org7728c68}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgb0b6af4}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org77fbf4c}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:orgf9cfc63}

\begin{frame}[label={sec:org0537149}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org5911366}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:orgc285a7c}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org428bbf4}

\begin{frame}[label={sec:orgb824510}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaaf2aa9}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org4b54456}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc1e2e22}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc02ff9e}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org787e4d2}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org939f531}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc12214c}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgffe1936}]{Conductancia}
...
\begin{frame}[label={sec:orgbe6e44b}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgfb94172}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:orgad0d83d}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgba3a8c2}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf4aeeba}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbd1c7e8}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge48ad1a}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1a131ce}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org3526c2a}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org91e24bd}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:orgd2b4f21}

\subsection{Método de las mallas}
\label{sec:orgc619966}

\begin{frame}[label={sec:org1eae78d}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd09f101}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5863380}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org4c48fc8}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org18ac8fb}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org150c903}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd241434}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga8faa02}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orge0e21fc}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgbfd2c6c}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org16f20a4}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org0503160}]{Procedimiento}
\begin{enumerate}
...
\label{sec:org1448ae7}
\begin{frame}[label={sec:orgbca9375}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6ce5ca9}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgbf3446c}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgbc2871a}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org8e5617a}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orge1ff533}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb3d43ec}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org48568ea}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\label{sec:orgc3574c2}

\subsection{Definiciones}
\label{sec:orgac213a9}

\begin{frame}[label={sec:orgc16ca39}]{Forma de Onda}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgaa204c8}]{Clasificación}
...
\label{sec:orgc7dcdc7}
\begin{frame}[label={sec:orgbbbe2d4}]{Escalón}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbca59a3}]{Escalón desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1f94669}]{Pulso}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7cd1ea6}]{Pulso desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9125314}]{Rampa}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2461105}]{Rampa desplazada}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgcf87bcb}]{Triangular}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge86c1f0}]{Triangular desplazada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\label{sec:org29a7177}


\begin{frame}[label={sec:org826be51}]{Tren de Pulsos Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/cuadrada_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge8f79b8}]{Tren de Pulsos Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/cuadrada0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5940c54}]{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbf07ebd}]{Onda Triangular Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/triangular0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgaa3c0e5}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:orgfc1ae7f}]{Valor medio y valor eficaz}
\begin{block}{Valor medio}
\[
