...
\begin{frame}[label={sec:org30ac55b}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org1dcaae2}]{Sistemas lineales}
...
\begin{frame}[label={sec:org59f00d4}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org8e5715d}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org734eab7}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org7be9c68}
\begin{frame}[label={sec:org00a8ea9}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orgf224f11}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org46c8d4e}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgb8ce01d}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org42af695}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org8cdc803}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:orgc3d1a45}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgd8e997b}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org0a297dc}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org4d26e71}

\subsection{Elementos Pasivos}
\label{sec:org13531a4}
\begin{frame}[label={sec:org2ca3497}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgc6763d4}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org6b74cbf}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org455ae02}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org919bcb5}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orga8fd014}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgee921f5}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgdf2b658}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:orgdb707a4}

\begin{frame}[label={sec:orgf72ee44}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4db72ba}]{Generador Real}
...
\label{sec:orgdccb140}

\subsection{Definiciones}
\label{sec:org40bb894}
\begin{frame}[label={sec:orgd9ef4ca}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org2a95d7a}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org7259fa3}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org625db72}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org4066d11}]{Balance de Tensiones}
\begin{center}
...
\label{sec:orgf4c083d}

\begin{frame}[label={sec:org2524afc}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orgcb69d65}]{Equivalencia de Fuentes}
...
\label{sec:org8a4448e}

\begin{frame}[label={sec:orgb1b721b}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaf496dd}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org1db8a48}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1b927e1}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5454c87}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2340a15}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgac1bf74}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org082270c}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org189e79f}]{Conductancia}
...
\begin{frame}[label={sec:org2f8c828}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orge69fa92}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org05c4976}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org69ea41e}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2f3cadf}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbc40a12}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgba67c21}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf64f8fc}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org30a86a2}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5e5a12b}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
