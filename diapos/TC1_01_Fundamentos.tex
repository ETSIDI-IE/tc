...
\begin{frame}[label={sec:org4766267}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org2b48704}]{Sistemas lineales}
...
\begin{frame}[label={sec:org60ba215}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org455f570}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4e6c44d}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org5340ace}
\begin{frame}[label={sec:org3229948}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orgd0aa869}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org47b8f71}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org3b92d00}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:orgb305eca}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:orge792140}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org9a111df}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org1b347f1}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orgdec58b5}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org9acf369}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgf2c5701}

\subsection{Elementos Pasivos}
\label{sec:org7a57c89}
\begin{frame}[label={sec:org9c14e67}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgc6168b8}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orgadf2e29}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orgf8fa81f}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org7ccd962}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org5e22799}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org7a19c7d}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgc05079a}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:orgff284eb}

\begin{frame}[label={sec:orgb18e7f8}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2640756}]{Generador Real}
...
\label{sec:org0964d9b}

\subsection{Definiciones}
\label{sec:orgdc3aba1}
\begin{frame}[label={sec:orgb06905b}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org767e7be}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org94c8a88}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgff8d252}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org801719d}]{Balance de Tensiones}
\begin{center}
...
\label{sec:org2819f0d}

\begin{frame}[label={sec:orgf0b7179}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org015cfb5}]{Equivalencia de Fuentes}
...
\label{sec:org86e6eb8}

\begin{frame}[label={sec:org065f138}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2ad9442}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org951e298}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc427ae0}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd07a960}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org92c3acb}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb87707a}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org43a44ac}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org482ac5f}]{Conductancia}
...
\begin{frame}[label={sec:org885db7e}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:org73c0be5}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:orgf383db1}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6035ce1}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org43d65c1}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org36898d8}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org98f1d04}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd63341e}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org38cf511}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbce5879}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:org0fe2a9c}

\subsection{Método de las mallas}
\label{sec:org1f60f70}

\begin{frame}[label={sec:org9516a38}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org10cf32f}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org0dd4a2e}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:orgaa07b48}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org8b0b42f}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org8c845e8}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orgac6d343}
\begin{frame}[label={sec:orgf2493ee}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8efe77e}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org8a697bf}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orga72fa3e}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org2d4b559}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orga026579}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orge9dc3e1}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org5b0229d}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
