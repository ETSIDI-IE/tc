...
\begin{frame}[label={sec:orgf0b8fb3}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:orgaeb32ab}]{Sistemas lineales}
...
\begin{frame}[label={sec:org11ba58f}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org7b21735}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org097c2ca}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org27fb6d3}
\begin{frame}[label={sec:orge4a0e81}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orga97ba98}]{La trayectoria no importa}
...
\begin{frame}[label={sec:orgbe7ec51}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgca4f635}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org96273b8}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org92f32c8}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org03825a7}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org6731b82}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org6236a66}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org68ae1d4}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org4dc0c5d}

\subsection{Elementos Pasivos}
\label{sec:orga109c9e}
\begin{frame}[label={sec:org9ed3dc2}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgbdabbf0}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orgc7cc061}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orgba33816}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org0552840}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgbc1e193}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org1269e79}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgc7df42b}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Condensador.pdf}
\end{center}
...
\label{sec:orgd6bff4e}

\begin{frame}[label={sec:org7ccd7ec}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgb65a6b2}]{Generador Real}
...
\label{sec:orgd54aaa8}

\subsection{Definiciones}
\label{sec:org4f48363}
\begin{frame}[label={sec:org1eebe66}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orga6a60f6}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgb80bad5}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgbc41ba3}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgb529826}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd0034cf}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{../figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:org9cd17ce}

\begin{frame}[label={sec:org02dd291}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orgec847a8}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:orgcb25c77}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org488d409}

\begin{frame}[label={sec:orgb2c5d0d}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0bfb1dc}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgc279b84}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5c43e0b}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf9caeab}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org29e7dc1}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6c9f2a9}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org75cd28b}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org7f2cb9a}]{Conductancia}
...
\begin{frame}[label={sec:orgeea600a}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orge3619b1}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org2fc5f28}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org014c3fc}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2cb73cc}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3119057}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge98edaf}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org09e835c}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orge7fd818}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2f4595d}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\label{sec:org549cc6f}

\subsection{Método de las mallas}
\label{sec:orgcdfef9e}

\begin{frame}[label={sec:org7c517a0}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org034955f}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc823c58}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\begin{frame}[label={sec:org1f6108c}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7733876}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org7a75745}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd3e75e7}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge63cc77}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org8a98d2e}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org2354a80}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org5139984}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org50fca0c}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orgd4eb192}
\begin{frame}[label={sec:orge0014de}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org47175d8}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgec6bf48}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orge50b87e}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org3a27816}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org14819d1}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgf8621fc}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:orge60108e}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\label{sec:orgb0f534f}

\subsection{Definiciones}
\label{sec:orga5e32fc}

\begin{frame}[label={sec:orgeeb7a02}]{Forma de Onda}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga98e934}]{Clasificación}
...
\begin{frame}[label={sec:orgd15f920}]{Valores que definen una onda periódica}
...
\begin{frame}[label={sec:org65fdc4b}]{Valores que definen una onda periódica}
\begin{itemize}
...
\label{sec:org3d7b4af}
\begin{frame}[label={sec:orgebf74c4}]{Escalón}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgb68d74c}]{Escalón desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd09b21b}]{Pulso}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org031cb1d}]{Pulso desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1406b04}]{Rampa}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org27c0ffd}]{Rampa desplazada}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0ecdd9f}]{Triangular}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgca3cfd9}]{Triangular desplazada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\label{sec:org2a2c98d}


\begin{frame}[label={sec:org90e7165}]{Tren de Pulsos Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/cuadrada_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb357c83}]{Tren de Pulsos Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/cuadrada0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1d891be}]{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2e8faa8}]{Onda Triangular Unidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular0_periodica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5b3fc33}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:org940ceae}]{Valor medio y valor eficaz}
\begin{block}{Valor medio}
\[
