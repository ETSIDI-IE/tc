...
\begin{frame}[label={sec:orgfa9faae}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org54b110c}]{Sistemas lineales}
...
\begin{frame}[label={sec:org229a974}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org8fb12a8}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org32d06de}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org1cfa4ea}
\begin{frame}[label={sec:org3f77864}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orge97c460}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org198cbae}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgd9bfc3c}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org2ec2f43}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org34a04be}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org6ad6bc4}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org71831d2}

\subsection{Elementos Pasivos}
\label{sec:org5898c9d}
\begin{frame}[label={sec:org79ff75c}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org73a3328}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org51c402e}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org96beb3d}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgf83a139}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orge2c463c}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\begin{frame}[label={sec:org4fc6854}]{Generador Real}
...
\label{sec:org4debc03}

\subsection{Definiciones}
\label{sec:org7f98a9e}
\begin{frame}[label={sec:org7244670}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org358bef3}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgef26e52}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgd930981}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2d55ce3}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2572a1b}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8b1fef4}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb59f6a6}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4df8ba3}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org6e798ee}]{Conductancia}
...
\begin{frame}[label={sec:orge17a3af}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:org56d17e6}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:orgf5ef473}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org7cf1b0c}]{Equivalencia de Fuentes}
