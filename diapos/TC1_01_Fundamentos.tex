...
\begin{frame}[label={sec:org848346a}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org9190012}]{Sistemas lineales}
...
\begin{frame}[label={sec:org55eb6ee}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org609c62a}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9a25890}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org29852ed}
\begin{frame}[label={sec:orgd180ccd}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org80d8f94}]{La trayectoria no importa}
...
\begin{frame}[label={sec:orge9b37f3}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org1a9968f}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:orgd4a6868}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org0706710}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org2c60307}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgcf543af}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org5d6f7ac}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org6f9cb9a}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgfe54ced}

\subsection{Elementos Pasivos}
\label{sec:org51702f5}
\begin{frame}[label={sec:org7bc1ba9}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org6de1094}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orga361859}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org4a49533}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org54d51d1}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org93b5aed}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd0db902}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org011e21b}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org20f01cd}

\begin{frame}[label={sec:org936f9a8}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc463884}]{Generador Real}
...
\label{sec:org24cce93}

\subsection{Definiciones}
\label{sec:org108b6e7}
\begin{frame}[label={sec:org43aff7a}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org64c9151}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgff273dd}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgfc59066}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgd96fc13}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org73af6ec}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:org3fbf153}

\begin{frame}[label={sec:orgcd8c908}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orgc624abc}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:org43f9140}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org85d5903}

\begin{frame}[label={sec:org4b1b9fb}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7989165}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org96b6046}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0b8383d}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga075965}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge99c764}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org864290f}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org240201d}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org5239f5e}]{Conductancia}
...
\begin{frame}[label={sec:org2bf1661}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgf57ed5d}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org437734e}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc92bf56}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3ffc6ed}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgce86810}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8b59ec6}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org53ed7f6}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgf070745}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0a3d1c0}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:org95ee7c8}

\subsection{Método de las mallas}
\label{sec:org77a0298}

\begin{frame}[label={sec:orge9771ba}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5cb94bf}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8403551}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org7f6cdc2}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org52e48f6}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org40a3e32}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org843fede}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2cebf17}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org970a755}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb978831}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org7bbd14a}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgf8373a1}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orga7d71b9}
\begin{frame}[label={sec:org6eb5ab9}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2ca8907}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org81c1285}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org2bc58b9}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org710caa2}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org5637668}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orged5a518}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org6f480d9}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
