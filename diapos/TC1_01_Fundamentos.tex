...
\begin{frame}[label={sec:orgef5dbad}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:orgde33a4e}]{Sistemas lineales}
...
\begin{frame}[label={sec:org627e571}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:orge032cd4}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0972685}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org6693a75}
\begin{frame}[label={sec:orgc0f2f04}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:orgb60b1bc}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org85be003}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orga080c32}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:orgd918b82}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org3f6c41a}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org2636c51}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org927dc27}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org889137e}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org7e8d684}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org5514743}

\subsection{Elementos Pasivos}
\label{sec:org1e06243}
\begin{frame}[label={sec:org288d88f}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgd9e6928}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orgb85c284}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orgd13361f}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:orgdc1e4b0}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org41cc618}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgf87ef9d}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgcf6a22c}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:orga304a5a}

\begin{frame}[label={sec:orgb79fca8}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgfb942f9}]{Generador Real}
...
\label{sec:org01cd47b}

\subsection{Definiciones}
\label{sec:orgc034842}
\begin{frame}[label={sec:org845b448}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orgd0056e5}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org2aaf1f6}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:orgb14fdce}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org2fdc708}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org898e96c}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:org605b02f}

\begin{frame}[label={sec:orge245df0}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org940905d}]{Equivalencia de Fuentes}
...
\label{sec:org8cdfe16}

\begin{frame}[label={sec:org2b8a15e}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org083102c}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org6252890}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org014d437}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3c7840a}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4b76ab8}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4855c65}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgef21a90}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgc25dbbe}]{Conductancia}
...
\begin{frame}[label={sec:org54fbc2b}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:org9065180}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org4e5cce4}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8db02d1}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd090b7c}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org73e9877}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2604cd2}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org61e07e0}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org522155e}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0c6fdb3}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:org6bee3b8}

\subsection{Método de las mallas}
\label{sec:orgbb1be25}

\begin{frame}[label={sec:orgdf12aa8}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc7e640b}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbb2ebb7}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org38bf69e}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6cdb47b}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:orgafca7cc}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf8e6f30}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7a30374}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org3793219}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgeb6d7d7}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org4045111}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org7098bfb}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orgac11616}
\begin{frame}[label={sec:org3cca55f}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org65834c5}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orge9d006b}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6e8c0ec}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgaa8020f}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org1e78168}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb9ca921}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org46796a1}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
