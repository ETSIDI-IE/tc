...
\begin{frame}[label={sec:org57e2c8b}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org30fc3e1}]{Sistemas lineales}
...
\begin{frame}[label={sec:org11bdeed}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org28bf3d3}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org59c7adf}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:orgf2449af}
\begin{frame}[label={sec:org8e32bfb}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org9306689}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org6125339}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgebf0f9a}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org1d4a1cd}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:orgda4e576}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org95aa60d}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org3e93d94}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orgba1a9d0}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org7b31484}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:org5379f51}

\subsection{Elementos Pasivos}
\label{sec:orgcf0c1de}
\begin{frame}[label={sec:orge87894c}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgb4885b2}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:orgde2c1b4}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:orga725b96}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:orgebf9073}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org72eecef}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb587e70}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org9d124dd}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org349282f}

\begin{frame}[label={sec:org6ebaab3}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5da872d}]{Generador Real}
...
\label{sec:orged71c7a}

\subsection{Definiciones}
\label{sec:org1c8f389}
\begin{frame}[label={sec:orgcde46f1}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orgeed1fc5}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org96c139e}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orgbc97f99}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:org100d9b1}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org3fc14e6}

\begin{frame}[label={sec:org24adaf5}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org52ce372}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org4d88c0d}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd0b4a3e}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgaf2fda3}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge4d9eee}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgdc79d3d}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga9c2cef}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org8ff52c0}]{Conductancia}
...
\begin{frame}[label={sec:org210f574}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgf9e0e2b}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org0972714}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2a1b2e5}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org76ff549}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc536eb3}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8500dc4}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org710a1e1}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4195efd}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org140f7d3}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:orgf044c67}

\subsection{Método de las mallas}
\label{sec:orgdd35ffc}

\begin{frame}[label={sec:orgb02146e}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd71f602}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org22ce728}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org6ce70e7}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orged8b4f0}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org3cfc89a}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1da0dc3}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9c61cc0}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgf86ad5c}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org5d927ad}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org4e99f3f}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org9ca4292}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orgff56222}
\begin{frame}[label={sec:org1d0c2fb}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge1c0097}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org70e42dc}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd3c2c50}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgfdc5e41}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org452e411}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb64097d}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:orge5eb12a}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
