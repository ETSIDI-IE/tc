...
\begin{frame}[label={sec:org8c0c533}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org7121b7a}]{Sistemas lineales}
...
\begin{frame}[label={sec:org3bb329c}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org79428c7}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8cb61ab}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org01828ca}
\begin{frame}[label={sec:org025f329}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org22a9d42}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org2200427}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgf4dcbd1}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org224c660}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org9fb14ea}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org24d5c4d}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgc93075f}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org206e99c}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org2e1ba93}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgcdf3803}

\subsection{Elementos Pasivos}
\label{sec:orge89223d}
\begin{frame}[label={sec:orgc08afd5}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8844ee}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org6038866}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org2455b9e}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org8caddab}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgf8f9f1c}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org032ff9c}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orge45e551}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:orge211d6d}

\begin{frame}[label={sec:org1e427a9}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4919deb}]{Generador Real}
...
\label{sec:org1025bf8}

\subsection{Definiciones}
\label{sec:orgc2f9f7f}
\begin{frame}[label={sec:org1e987f4}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orge700b50}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orga9458e2}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org3be1d78}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:orgefe4952}]{Balance de Tensiones}
\begin{center}
...
\label{sec:orgb93c859}

\begin{frame}[label={sec:orgabe929b}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org009c4ae}]{Equivalencia de Fuentes}
...
\label{sec:orgbef31be}

\begin{frame}[label={sec:orgc2d5f4c}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org218f2df}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgb2297c1}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org118597d}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7f7bb65}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org006399f}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org20dd9b0}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5d94674}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:org42b7547}]{Conductancia}
...
\begin{frame}[label={sec:org5aff4ec}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgd79b35f}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org7fbb21f}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbf5e4a6}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeea1df2}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdf1083b}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbd0b1c7}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org93b83ff}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgad0a45f}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaecff54}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:org48a3193}

\subsection{Método de las mallas}
\label{sec:orgb8bd8fb}

\begin{frame}[label={sec:org3de3b9c}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgdce2df3}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org74bc32b}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:org4e16f9a}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb86f5b9}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org31450b6}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1d4675b}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge60a0a2}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org8463ea5}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgcb132e4}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org6af29b0}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org662d496}]{Procedimiento}
\begin{enumerate}
...
\label{sec:org5222fa9}
\begin{frame}[label={sec:org73eea48}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org33491ab}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org349009d}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org34c243e}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org9074885}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org924da0b}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc6a5771}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:orgce88542}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
