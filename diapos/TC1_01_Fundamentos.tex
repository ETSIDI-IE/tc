...
\begin{frame}[label={sec:org3e9d101}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org566c0ef}]{Sistemas lineales}
...
\begin{frame}[label={sec:orge98832c}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:org78c9c28}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org683f589}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org9e20616}
\begin{frame}[label={sec:org54cffb3}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org707d016}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org0f0eeb6}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orge71a010}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org3465a84}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org9085b8e}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:orgae47b78}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org2816235}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:orged3527c}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:org849af11}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgbe0bde0}

\subsection{Elementos Pasivos}
\label{sec:org19f1924}
\begin{frame}[label={sec:org85bb01d}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:orgf206fea}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org6e65efc}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org5c29838}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org88afbe0}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org13c9b1a}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgac339e6}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orgd9f38e9}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/Condensador.pdf}
\end{center}
...
\label{sec:org1edb76e}

\begin{frame}[label={sec:org9d45eea}]{Generadores de Tensión y Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0484348}]{Generador Real}
...
\label{sec:orge777d82}

\subsection{Definiciones}
\label{sec:orgdecc5d2}
\begin{frame}[label={sec:org7c6d763}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org580739b}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orge27ec10}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org56c23d8}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org36ce575}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfae83c7}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:orgd9179a0}

\begin{frame}[label={sec:org65f6ff3}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orga5f6b3c}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:org9e43091}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org7607343}

\begin{frame}[label={sec:org6187576}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2a0ec7}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgb68536b}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb1f6eca}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd17cf75}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9b98737}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6f5737c}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8fa9c72}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgca0b056}]{Conductancia}
...
\begin{frame}[label={sec:orgad13432}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orgbe366c0}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org9d2cc96}]{Conexión en paralelo de condensadores}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org54b10f4}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org19e209d}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org382690b}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb8ad9f2}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3107c74}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd9fc229}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1830b12}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Conexion_Estrella.pdf}
...
\label{sec:org5df34c0}

\subsection{Método de las mallas}
\label{sec:orgb1c302b}

\begin{frame}[label={sec:orgb2a45a0}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga529137}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdf4b290}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\begin{frame}[label={sec:orgd6d5b9a}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org86575b0}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org5920b26}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org211d1c6}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6795cb9}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org1801af2}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgf8d59ab}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org50ffa98}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org79371fb}]{Procedimiento}
\begin{enumerate}
...
\label{sec:orgad3bb06}
\begin{frame}[label={sec:org51009ec}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgaa280ab}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgde238d3}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orge8661b6}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org009914b}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orge2ba63c}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd6e33cb}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org0e00eed}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\label{sec:orgf615d0d}

\subsection{Definición}
\label{sec:orgda21f36}

\begin{frame}[label={sec:org35f85b6}]{Forma de Onda}
\end{frame}

\subsection{Tipos}
\label{sec:orgb52f208}
\begin{frame}[label={sec:orgec0a0d7}]{Escalón}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7552415}]{Escalón desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf22460a}]{Pulso}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgba60a5d}]{Pulso desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5f6cd01}]{Rampa}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3b30555}]{Rampa desplazada}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2d7dc03}]{Triangular}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf205357}]{Triangular desplazada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
