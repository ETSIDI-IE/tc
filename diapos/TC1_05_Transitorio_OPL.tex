...
\end{frame}
\begin{frame}[label={sec:org7e08ead}]{Circuito en \(t > 0\)}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org34d3dcd}]{Respuesta Natural}
Apagamos la fuente:
\begin{columns}
...
\]
\end{frame}
\begin{frame}[label={sec:orga1e1bdd}]{Constante de tiempo}
\[
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org24df3a5}]{Respuesta forzada}
...
\]
\end{frame}
\begin{frame}[label={sec:org056b230}]{Respuesta forzada}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org0834b4c}]{Respuesta completa}
\begin{equation*}
...
\]
\end{frame}
\begin{frame}[label={sec:org83e206c}]{Respuesta completa}
\[
  \boxed{i(t) = \frac{U_0}{R}(1 - e^{-\frac{t}{\tau}})  }
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc468f19}]{Expresión general de la respuesta completa}
\[
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8140788}]{Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/Thevenin_PrimerOrden.pdf}
\end{center}
\end{frame}
\subsection{Circuito RC paralelo}
\label{sec:org6a18940}

\begin{frame}[label={sec:orgba1f0df}]{Circuito básico}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org965126b}]{Condiciones iniciales}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgd1c0e1e}]{Respuesta natural}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgeb96aff}]{Constante de tiempo}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9e769e3}]{Derivadas en \(t = 0^+\)}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgfc494f3}]{Respuesta Completa}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orga08214b}]{Ejemplo de Respuesta Completa}
...
\label{sec:org66a4497}
\begin{frame}[label={sec:org4aaa988}]{Circuito básico}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/transitorio_circuitoRLC_paralelo.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgab85c81}]{Respuesta natural (t > 0)}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb923a48}]{Solución}
\begin{block}{Ecuación diferencial}
\[
  \diff[2]{u}{t} + \frac{G}{C} \diff{u}{t} + \frac{1}{LC} u = 0
\]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1c1f4ec}]{Parámetros}
\begin{block}{Ecuación característica}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{align*}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org54d7dfa}]{Tipos de Respuesta}
\begin{itemize}
