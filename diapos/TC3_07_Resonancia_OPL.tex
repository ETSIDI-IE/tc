...
\begin{frame}[label={sec:orgaf235d3}]{Ancho de Banda y Factor de Calidad}
\begin{columns}
...
\begin{frame}[label={sec:org0a6f6ff}]{Ancho de Banda y Factor de Calidad}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Q_B.pdf}
\end{center}
\end{frame}
\section{Circuito RLC paralelo}
\label{sec:org525b08c}


\begin{frame}[label={sec:orgf7fa7e6}]{Admitancia}
\begin{center}
...
\begin{frame}[label={sec:org3c0ffb9}]{Puntos de Potencia Mitad}
\begin{itemize}
...
\begin{frame}[label={sec:org5a6f06e}]{Ancho de Banda y Factor de Calidad}
\begin{itemize}
\item Resultado
\end{itemize}
\begin{align*}
...
\begin{frame}[label={sec:org073073d}]{Balance de corrientes en resonancia}
\begin{center}
\includegraphics[height=0.35\textheight]{../figs/RLC_paralelo_resonante.pdf}
\end{center}
...
\begin{frame}[label={sec:org129babc}]{Balance de corrientes en resonancia}
\begin{center}
...
\begin{frame}[label={sec:org8d67999}]{Balance de Energías}
\[
  u(t) = U_0 \sin(\omega t)
\]
...
\begin{frame}[label={sec:orgbbef801}]{Nueva definición del Factor de Calidad}
\begin{itemize}
...
\begin{frame}[label={sec:org827464f}]{La curva de resonancia \alert{no} es simétrica}
...
\begin{frame}[label={sec:orgff33356}]{La curva de resonancia \alert{no} es simétrica}
\begin{itemize}
...
\begin{frame}[label={sec:org2c2788b}]{Aproximación para circuitos con alto \(Q_0\)}
\begin{itemize}
...
\begin{frame}[label={sec:orge3de197}]{Admitancia en función de \(\omega_0\) y \(Q_0\)}
\begin{itemize}
...
\begin{frame}[label={sec:org0fa973a}]{Desintonización Relativa}
\begin{itemize}
...
\begin{frame}[label={sec:org3369129}]{Aproximación para cercanías de la resonancia}
\begin{itemize}
...
\begin{frame}[label={sec:orgd4cce10}]{Curva Universal de Resonancia}
\begin{columns}
...
\begin{frame}[label={sec:org9dd4866}]{Tensiones y energías}
\begin{itemize}
...
\begin{frame}[label={sec:org20844ba}]{Curva Universal de Resonancia}
\begin{itemize}
...
\label{sec:orgf2cb45b}

\begin{frame}[label={sec:orgf03f39e}]{Circuito RLC con bobina real}
\begin{center}
...
\begin{frame}[label={sec:org2fc64e7}]{Impedancia}
\[
...
\]
\end{frame}
\begin{frame}[label={sec:orge8f118c}]{Comparación con RLC paralelo}
\begin{itemize}
...
\label{sec:orgdb8ecf6}
\begin{frame}[label={sec:org489261c}]{Factor de Calidad}
\begin{itemize}
...
\begin{frame}[label={sec:org844650f}]{Bobina Real}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:org50867d3}]{Condensador Real}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org2423db7}]{Ejercicio}
...
\begin{frame}[label={sec:org5317f0b}]{Conversión serie-paralelo}
\begin{columns}
...
\begin{frame}[label={sec:org6dfa41a}]{Conversión serie-paralelo}
\[
  \begin{array}{l}
...
\begin{frame}[label={sec:orgd09bf73}]{Conversión Serie-Paralelo}
...
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CondensadorParalelo.pdf}
\end{center}
\end{column}
\end{columns}
\end{frame}

\begin{frame}[label={sec:org37699af}]{Aplicación: transformación de circuito RLC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/resonante_real.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgadd65f6}]{Ejercicios Recomendados}
\begin{itemize}
