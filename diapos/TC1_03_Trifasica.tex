...
\label{sec:org77a487d}
\begin{frame}[label={sec:org4400c7a}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgc3ecb11}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:orgcb9f1f7}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org6fb062a}
\begin{frame}[label={sec:org746dede}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org916df9e}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:orga2d9381}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:orgbe6531c}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org3a6ba25}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf3856d9}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org5ae8e5d}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org932c4b3}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org28782e1}
\begin{frame}[label={sec:orgae7e66a}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org3116890}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9a79d8a}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7934b00}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc6cbe3b}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org59be6c2}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5686da9}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org6400021}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgac491b5}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org58338a5}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org33164ec}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga949cc8}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1bc7fd4}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:orgf24d1a0}

\begin{frame}[label={sec:org95e1020}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:orgfc3ee00}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:orgc817b6e}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org3664610}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgf2e8da8}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orga7a8b6a}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgc6c5b65}]{Comparativa Monofásica-Trifásica}
...
\label{sec:org5606117}
\begin{frame}[label={sec:orgfe5e3bd}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf065761}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org78847e2}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org18e73f7}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1b250da}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org1e1b502}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org84fa138}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org7f83e62}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org22f70e5}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org01465a5}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org35db6d0},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org3ca607a},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org3e12e5c}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:orgf6d53b6}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge043047}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:org4665632}

\begin{frame}[label={sec:org772521b}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org01fed45}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2f194bf}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org19e579b}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
