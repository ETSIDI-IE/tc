...
\label{sec:orgd2cdbc5}

\begin{frame}[label={sec:orgb69241f},plain]{}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge87e104}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:org0919e29}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:org63fcc9d}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:orge2f97cb}
\begin{frame}[label={sec:orgf78de1a}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org2dd0bce}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org6cd3d2e}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:orgaf2c4e2}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orge4f6219}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc345e0f}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org8560bc3}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org5a57346}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org9dbc31d}
\begin{frame}[label={sec:org8aabce7}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org76106be}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge8511d1}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6ea2359}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb3adaf8}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1649b43}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5cbe0df}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgbabaa5d}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgdf2e355}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6ee5c14}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org3a020a1}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3a98a70}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3673ccb}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org92e9463}

\begin{frame}[label={sec:orgd7b72e8}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org7bfd405}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:orgc75d346}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org716ca3b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org66397d4}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org18d4412}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org050d954}]{Comparativa Monofásica-Trifásica}
...
\label{sec:org31f137b}
\begin{frame}[label={sec:orga1504bf}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgca0ae98}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgcb32d46}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf009348}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgefae5ea}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:orga6aac83}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org6029d2e}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:orge79ef6a}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org72d84f3}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org1aefd1c}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8a3910a},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org5b37a50},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:orgdb1bc0a}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org2cdb6ed}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbc21d3a}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:org25ff50d}

\begin{frame}[label={sec:orgb7719a3}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org1f241c4}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga8407d1}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge66d778}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
