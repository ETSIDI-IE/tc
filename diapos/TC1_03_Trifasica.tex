...
\begin{frame}[label={sec:org3af4e05}]{Fasores de un sistema trifásico}
\begin{center}
...
\begin{frame}[label={sec:orgfd213ff}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org22dd587}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org6b798b1}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5289d61}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orgfbcf15d}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgf71be67}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org64ab65e}
\begin{frame}[label={sec:orgd91a55f}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org65e4eec}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org15ca9c5}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org59acf7d}]{Receptor en Triángulo Equilibrado}
\begin{center}
...
\begin{frame}[label={sec:org1d3f843}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgaf3a687}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0495d1e}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org423fd2f}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org416a278}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org88c05a9}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge09a285}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orga1695ae}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org806b23b}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgf6dedc7}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org6720727}]{Comparativa Monofásica-Trifásica}
...
\label{sec:org0861add}

\begin{frame}[label={sec:orge90cb44}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:orgce37ca6}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgff543d1}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge5a58df}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org046c601}
\begin{frame}[label={sec:org269e122}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb4a04a6}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orge88e205}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga476a57}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1ed2de1}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org14d5278}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org247505f}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:orga5c48a6}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgc403b88}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgf2ca0d2}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc9d57fd},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org3a99370},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org8e54bbc}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:orgd0ceced}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2639dc9}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
