...
\label{sec:orge7ae95e}
\begin{frame}[label={sec:org9a36f11}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:org4e17fbf}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:org26018ef}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org918dcf2}
\begin{frame}[label={sec:org4f81db3}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org650762f}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:orgb64979f}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc15a953}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org4e7fc16}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org079afa5}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orgbeeccef}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgbef9914}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orgaca5279}
\begin{frame}[label={sec:org9b3f417}]{Tipos de Receptores}
...
\begin{frame}[label={sec:orge108383}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgceb7a31}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb5589f8}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org03112a1}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org650951b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga0930b2}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgae91ec1}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9f1aee2}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org10e4ddf}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org9ae6c2b}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org96a33a8}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org10adb91}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org08b1b66}

\begin{frame}[label={sec:org9a9eed4}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org2b123c7}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org2aa16d8}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org5f99caa}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org233f9ba}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org30b9d34}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orge04953e}]{Comparativa Monofásica-Trifásica}
...
\label{sec:orgba540aa}
\begin{frame}[label={sec:org1e496b2}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgc3f6856}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orga87a2fc}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga095e24}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgaa10ffd}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:orgda870fc}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgea120db}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org34f5890}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orga15a0f7}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org2c10a62}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org050faba},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org27f4392},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:orgb61d606}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:orgc01cb47}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Reactiva3H_A-BC.pdf}
...
\begin{frame}[label={sec:orga62d98c}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:orge3b5411}

\begin{frame}[label={sec:orgf54b378}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org58e5bf0}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org00beb79}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3f732aa}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
