...
\label{sec:org96af9e8}
\begin{frame}[label={sec:org48f7e2b}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:org1c798a4}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:org75146db}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org1b82bb0}
\begin{frame}[label={sec:orgdfe24ea}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:orgad91da9}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org58032fa}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:orga956d6d}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org2a30ee4}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf93a45f}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orgd7941db}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org7be15d3}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orged2b396}
\begin{frame}[label={sec:org8014eb0}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org762e5d7}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6e756c4}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org26fe324}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgafa03db}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1de06bd}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8f4ca4b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgdfc56c8}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3e73ceb}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org714e458}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org61e1d06}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1d94291}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbe2149a}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:orgddf6ab8}

\begin{frame}[label={sec:orgafc0440}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org68ab5d0}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org08b97eb}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgdbc7c2b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org27f14ec}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orge92a8d2}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgb334317}]{Comparativa Monofásica-Trifásica}
...
\label{sec:orgc1dd67c}
\begin{frame}[label={sec:orgab040a3}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org3c0a02f}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org247f184}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Potencia4H_Equilibrado.pdf}
\end{center}
\end{column}
...
\begin{frame}[label={sec:orgd8a629e}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0dc52fd}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org6e86f6f}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org340251c}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org31acdd9}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org3acfbf5}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org7e8ff3d}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5a887dd},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org39c7302},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org782179d}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org049addc}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Reactiva3H_A-BC.pdf}
...
\begin{frame}[label={sec:orgb61e476}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:org43d052e}

\begin{frame}[label={sec:org3ee8b53}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:orgde1829c}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc936abb}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org81f5d6b}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
