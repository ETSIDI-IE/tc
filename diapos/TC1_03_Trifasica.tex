...
\begin{frame}[label={sec:org5e5ecc0}]{Fasores de un sistema trifásico}
\begin{center}
...
\begin{frame}[label={sec:orgc369576}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:orgaaddf99}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgb1dc57c}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5806588}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orga00b8f3}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org0a59831}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org198fb5f}
\begin{frame}[label={sec:orgc7acf58}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org69304cb}]{Receptor en Estrella Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgad24ea2}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org57f0e23}]{Receptor en Triángulo Equilibrado}
\begin{center}
...
\begin{frame}[label={sec:orgbf1ba9c}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org693faa9}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8dfc91f}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orge37e634}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb7984ed}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4e29e78}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge4ed7cb}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org42db6b6}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org98b70db}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org1cf89c1}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgc2ede6b}]{Comparativa Monofásica-Trifásica}
...
\begin{frame}[label={sec:orgb9dfc28}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2de2c44}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgb598fde}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org1ad15c9}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgf9ba48a}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org55bf1ca}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd06e1f5},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:orga85a5cb},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org1d221cb}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org3ea8a86}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org65f9468}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgabcb1d6}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org686a88d}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
