...
\label{sec:org6b5de7a}

\begin{frame}[label={sec:org5c8d247}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org89df188}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org550b7bd}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org392fc3f}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:orgc891199}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:orgb920a50}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6b31fb3}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:orgf595503}

\begin{frame}[label={sec:org7a6392f}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orge139b4e}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:org8ccc223}]{Teorema de sustitución}
\begin{center}
...
\label{sec:orgc98fa70}

\begin{frame}[label={sec:org583c807}]{Planteamiento}
...
\begin{frame}[label={sec:org0c0f288}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5519bd3}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd737097}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:org343d30d}]{Solución}
...
\label{sec:orgcfa4225}

\begin{frame}[label={sec:org5d1818f}]{Planteamiento}
...
\begin{frame}[label={sec:orgc7bb70b}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:orgeadf86e}]{Aplicación}
...
\label{sec:orgf08e85f}

\begin{frame}[label={sec:orgcd4ae19}]{Planteamiento}
...
\begin{frame}[label={sec:org0b0153b}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:org52bbcc7}]{Corrientes en la estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_Y.pdf}
...
\begin{frame}[label={sec:org7131a00}]{Resolución}
...
\begin{frame}[label={sec:org8592965}]{Aplicación}
\begin{itemize}
...
\label{sec:orgd07b642}

\begin{frame}[label={sec:org577800e}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org8172e10}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orga16924e}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org5f6c4ad}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org66ccb8a}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org2ed9def}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgfb325ab}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org1adf92c}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org05499d4}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org3db3f02}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgefb1f5c}]{Máxima Transferencia de Potencia}
...
\label{sec:orgb0443ad}

\begin{frame}[label={sec:org73c8815}]{Planteamiento}
...
\begin{frame}[label={sec:org7a22359}]{Potencia}
...
\begin{frame}[label={sec:org26cabcc}]{Redes en cascada}
...
\begin{frame}[label={sec:org2f0a231}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org65100c9}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org9de27a1}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org9bf47e7}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org19f525e}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orge83628b}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org8a0d530}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:org63fd922}]{Pérdidas de inserción}
