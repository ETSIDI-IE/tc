...
\label{sec:org1b0c682}

\begin{frame}[label={sec:orga8ac639}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org5462330}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:orgceb9832}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org7ad1a2f}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org652e2f3}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org1ea4b3b}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org9a8cd6a}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:org1c9dc5a}

\begin{frame}[label={sec:org69d93ae}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:org92ba09b}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orgbd5528c}]{Teorema de sustitución}
\begin{center}
...
\label{sec:org7bfcfaf}

\begin{frame}[label={sec:org8b1ce5c}]{Planteamiento}
...
\begin{frame}[label={sec:org6fa6c2e}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge08fd15}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9b11ff4}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:org7a6d150}]{Solución}
...
\label{sec:org90b5f77}

\begin{frame}[label={sec:orgd52e568}]{Planteamiento}
...
\begin{frame}[label={sec:org41e0c87}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:orge0deae4}]{Aplicación}
...
\label{sec:org6d13f3e}

\begin{frame}[label={sec:org294462b}]{Planteamiento}
...
\begin{frame}[label={sec:org726a54f}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:org1aedcad}]{Corrientes en la estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_Y.pdf}
...
\begin{frame}[label={sec:org29265a0}]{Resolución}
...
\begin{frame}[label={sec:org18fbf3d}]{Resolución}
...
\begin{frame}[label={sec:org7537808}]{Aplicación}
\begin{itemize}
...
\label{sec:orgb4227dc}

\begin{frame}[label={sec:org6726526}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org301f816}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgfe8d922}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgc1a1c33}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgdf4a2fb}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org79a443c}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgcff0412}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org45684e7}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org11f464e}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org55aabd6}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org7a9f19e}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org01fab4c}]{Máxima Transferencia de Potencia}
...
\label{sec:org4f4dbf5}

\begin{frame}[label={sec:orgecd0aba}]{Planteamiento}
...
\begin{frame}[label={sec:org7ed3eaf}]{Potencia}
...
\begin{frame}[label={sec:org3ae5e7f}]{Redes en cascada}
...
\begin{frame}[label={sec:orgc9b6dd2}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:orgaba4ce7}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org03d77f0}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org74283e9}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:orgfc8c1e9}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orgd0cfece}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org0e02f8d}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:orga337d59}]{Pérdidas de inserción}
