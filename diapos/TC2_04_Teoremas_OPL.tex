...
\label{sec:org300c935}

\begin{frame}[label={sec:org8cb03c4}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org42c64bf}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org5e163ad}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:orgad10700}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:orgd7cacfc}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:orgb2229ed}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org0ccf014}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:orgc0c73fd}

\begin{frame}[label={sec:org78666c1}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orgc5cbc3e}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:org59ac824}]{Teorema de sustitución}
\begin{center}
...
\label{sec:orgf3d2033}

\begin{frame}[label={sec:org72755d6}]{Planteamiento}
...
\begin{frame}[label={sec:orgfa53c7a}]{Solución}
...
\label{sec:org73bbdab}

\begin{frame}[label={sec:orge15b837}]{Planteamiento}
...
\begin{frame}[label={sec:org2fa586c}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:orgec4c091}]{Aplicación}
...
\label{sec:orgcfb4dd8}

\begin{frame}[label={sec:org11253d3}]{Planteamiento}
...
\begin{frame}[label={sec:org79a8df9}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:org41457c8}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org1fd334d}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgc6cc77b}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org2c5f35f}]{Planteamiento}
...
\begin{frame}[label={sec:orgd06722a}]{Potencia}
...
\begin{frame}[label={sec:orgedbf848}]{Redes en cascada}
...
\begin{frame}[label={sec:org7a17b9f}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:orge10703b}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org90dc7b4}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:orge883dbd}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org056f799}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org80df91e}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orgb032fb7}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:orge3fb14a}]{Pérdidas de inserción}
