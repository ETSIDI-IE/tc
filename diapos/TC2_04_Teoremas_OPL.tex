...
\label{sec:org5b50af7}

\begin{frame}[label={sec:org292bd3f}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org79c0c83}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org2ea89a3}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org694951f}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:orgc76d8e3}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org9dcaa81}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org12695cf}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:org4c9b691}

\begin{frame}[label={sec:org584c327}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orgd20ad3b}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:org62934ec}]{Teorema de sustitución}
\begin{center}
...
\label{sec:org735a55b}

\begin{frame}[label={sec:org44edb46}]{Planteamiento}
...
\begin{frame}[label={sec:org3d479e9}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org727577d}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd6792dc}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:orgaa3b16d}]{Solución}
...
\label{sec:orgdbf2b6f}

\begin{frame}[label={sec:org95dcb63}]{Planteamiento}
...
\begin{frame}[label={sec:org25b4807}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:org6105427}]{Aplicación}
...
\label{sec:orge62a91c}

\begin{frame}[label={sec:orga32972b}]{Planteamiento}
...
\begin{frame}[label={sec:org68679e3}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:org6db9dd1}]{Corrientes en la estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_Y.pdf}
...
\begin{frame}[label={sec:org4cfaaee}]{Resolución}
...
\begin{frame}[label={sec:orgf188aad}]{Resolución}
...
\begin{frame}[label={sec:orgba77966}]{Aplicación}
\begin{itemize}
...
\label{sec:org950e8f7}

\begin{frame}[label={sec:orgcc8a7de}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org7b97c2e}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgf16a444}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgf3d4152}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgfbcab31}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgb3f9bc1}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgc873c5f}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgcc264d1}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgc3add41}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orge385fa6}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org46789ef}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgce6831b}]{Máxima Transferencia de Potencia}
...
\label{sec:org8aeee1f}

\begin{frame}[label={sec:org9375a99}]{Planteamiento}
...
\begin{frame}[label={sec:org69ced08}]{Potencia}
...
\begin{frame}[label={sec:org9c183d4}]{Redes en cascada}
...
\begin{frame}[label={sec:org7915fdd}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org959dada}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:orgb74acde}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org1d96da4}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:orge7c10cf}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orge0c06d0}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orgfb0d504}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:orgd4916fc}]{Pérdidas de inserción}
