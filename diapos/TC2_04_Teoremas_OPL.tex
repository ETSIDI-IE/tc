...
\label{sec:orgbe4b43a}

\begin{frame}[label={sec:org834b99c}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org3cca2bc}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org16a24f8}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org4e51118}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org681ec3d}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org1121ca3}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org276bf8d}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:org8a44a4e}

\begin{frame}[label={sec:orgca7b85f}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orge0732fb}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orga7946f1}]{Teorema de sustitución}
\begin{center}
...
\label{sec:orgc17b027}

\begin{frame}[label={sec:org12074f5}]{Planteamiento}
...
\begin{frame}[label={sec:orge0ecb7a}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgdb6ee69}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3010f8e}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:org76b5531}]{Solución}
...
\label{sec:orge29cd3d}

\begin{frame}[label={sec:org8af47c4}]{Planteamiento}
...
\begin{frame}[label={sec:org1a4ef27}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:orgaf68f6b}]{Aplicación}
...
\label{sec:orgc8b3c85}

\begin{frame}[label={sec:org3d3b132}]{Planteamiento}
...
\begin{frame}[label={sec:orga0e1ebe}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:orgcd5a83e}]{Corrientes en la estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_Y.pdf}
...
\begin{frame}[label={sec:org3178c57}]{Resolución}
...
\begin{frame}[label={sec:org97505a8}]{Resolución}
...
\begin{frame}[label={sec:org44c0338}]{Aplicación}
\begin{itemize}
...
\label{sec:orga02ab56}

\begin{frame}[label={sec:orgbb258e0}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org1707ef2}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org6d153a6}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org8a4ea0f}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgde0909c}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orga79c011}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgc7bb9d8}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org80de70d}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org405ca28}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgbcca91f}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org0580b66}]{Máxima Transferencia de Potencia}
...
\label{sec:org8267de1}

\begin{frame}[label={sec:orgf1befc3}]{Planteamiento}
...
\begin{frame}[label={sec:orga47fc97}]{Potencia}
...
\begin{frame}[label={sec:orgf0814f0}]{Redes en cascada}
...
\begin{frame}[label={sec:org98d3429}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org5796ed2}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:orgba7a8d6}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org310777c}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org6fc12d6}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org19ae50e}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org30c3f16}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:org4f9381e}]{Pérdidas de inserción}
