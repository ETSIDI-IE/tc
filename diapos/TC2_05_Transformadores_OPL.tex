...
\begin{frame}[label={sec:orgf3c8fcd}]{Recordatorio}
\begin{columns}
...
\label{sec:org0fb4e16}

\begin{frame}[label={sec:org8acb143}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:org10074dd}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgedc1a12}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\label{sec:org705be14}
\begin{frame}[label={sec:orgc57db29}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb3f5526}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org717c39c}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org20958be}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:orgeec0d6b}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orge02ed5b}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:org0e555d3}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org277807b}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org42bff7c}]{Tensión de Thévenin}
\begin{columns}
...
\begin{frame}[label={sec:org524d1a6}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org154afac}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga7b2fc9}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5dee1f5}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\label{sec:orgbc9be32}
\begin{frame}[label={sec:orgdcf5f7c}]{Definición}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org0c2eef2}]{El flujo en cada bobina es nulo}
...
\label{sec:org1f7577a}
\begin{frame}[label={sec:orgf2fc640}]{Fuente de Tensión de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org6f4224f}]{Fuente de Tensión de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org856ccc6}]{Fuente de Corriente de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgfb5c524}]{Fuente de Corriente de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org1cc393e}]{Impedancia de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org5bd9fa1}]{Impedancia de Primario a Secundario}
\begin{center}
...
\label{sec:orga4b4634}
\begin{frame}[label={sec:orgcf55200}]{Recordatorio: impedancia de entrada de un T. Perfecto}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgc57da02}]{Circuito equivalente con transformador ideal}
\begin{columns}
...
\begin{frame}[label={sec:org5fa297a}]{Recordatorio: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\begin{frame}[label={sec:orgead6c26}]{Equivalente en primario con transformador ideal}
\[
  \overline{Z}_{th} = \frac{1}{a^2} \cdot \frac{j \omega L_1 \cdot \overline{Z}_g}{j\omega L_1 + \overline{Z}_g}
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org68efdb5}]{Equivalente en secundario con transformador ideal}
\[
...
\label{sec:orgf85c850}
\begin{frame}[label={sec:org61ccc00}]{Transformador Real de Varios Devanados}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6a045a5}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:org5ab4b0a}]{Transformador Perfecto}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdbbb5f3}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:org73aae5b}]{Relaciones de Transformación}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgaf38494}]{Transformador Ideal}
\begin{center}
...
\begin{frame}[label={sec:org98fae26}]{Ecuaciones del Circuito Alternativo}
\begin{center}
