...
\begin{frame}[label={sec:org8553e35}]{Recordatorio}
\begin{columns}
...
\label{sec:org4d634fc}

\begin{frame}[label={sec:org1362051}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orga6cf860}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orge839ed5}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:orgfeeb54d}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:org771998e}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Real_FuentePrimario.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org11d5e93}]{Tensión de Thévenin}
\begin{columns}
...
\begin{frame}[label={sec:orga9475c0}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Real_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd7db8db}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Real_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb8f2c1d}]{Impedancia de Thévenin}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3e45c61}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Real_FuentePrimario.pdf}
\end{center}
...
\label{sec:org21428f5}
\begin{frame}[label={sec:orgfd77f11}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgfa59d4d}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org31b2e10}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb3f30ad}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:org5f318a8}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orged48d92}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:org5b5a8bc}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org85474b9}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgef8b5e3}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbeb84fb}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org19ed5a4}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb2ad5ab}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6076f89}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
