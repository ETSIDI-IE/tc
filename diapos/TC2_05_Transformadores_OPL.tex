...
\begin{frame}[label={sec:org1222eeb}]{Recordatorio}
\begin{columns}
...
\label{sec:org0f70e55}

\begin{frame}[label={sec:orge9adf68}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orgcb26d4c}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org507d235}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:org5799ad6}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
Combinando con la ecuación del primario:
\[
  \overline{Z}_{in}  = \frac{\overline{U}_1}{\overline{I}_1} =  (R_1 + j \omega L_1) + \frac{\omega^2 M^2}{(R_2 + j \omega L_2) + \overline{Z}_L}
\]
\end{frame}

\section{Transformador Perfecto}
\label{sec:orgea7ef11}
\begin{frame}[label={sec:org315662d}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgc8777d2}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org0016b6a}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org487497e}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:org9ab0995}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org285b841}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:org9946757}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org673c523}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org98dad3a}]{Tensión de Thévenin}
\begin{columns}
...
\begin{frame}[label={sec:orgb8dddae}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org32376ae}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org140351f}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdcf190c}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\label{sec:org452e8e0}
\begin{frame}[label={sec:org6d2697e}]{Definición}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org9815bb5}]{El flujo en cada bobina es nulo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgdb4683c}]{El flujo mutuo es nulo}
...
\]
\end{frame}
\begin{frame}[label={sec:org7665c30}]{Relación de Transformación}
Hemos obtenido:
\[
...
\]
\end{frame}
\begin{frame}[label={sec:org4870db0}]{Un transformador ideal no consume potencia}
\[
...
\label{sec:org797b5a3}
\begin{frame}[label={sec:org7259ab3}]{Fuente de Tensión de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org36a3378}]{Fuente de Tensión de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org35a19c9}]{Fuente de Corriente de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgdee278f}]{Fuente de Corriente de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org90304af}]{Impedancia de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgd173b6b}]{Impedancia de Primario a Secundario}
\begin{center}
...
\label{sec:org79f17c5}
\begin{frame}[label={sec:org7905d21}]{Recordatorio: impedancia de entrada de un T. Perfecto}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf930361}]{Circuito equivalente con transformador ideal}
\begin{columns}
...
\begin{frame}[label={sec:orgc0957aa}]{Recordatorio: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\begin{frame}[label={sec:org5980951}]{Equivalente en primario con transformador ideal}
\[
  \overline{Z}_{th} = \frac{1}{a^2} \cdot \frac{j \omega L_1 \cdot \overline{Z}_g}{j\omega L_1 + \overline{Z}_g}
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org96f9612}]{Equivalente en secundario con transformador ideal}
\[
...
\label{sec:org6a1c778}
\begin{frame}[label={sec:org8117241}]{Transformador Real de Varios Devanados}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2e66584}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orgc2204d0}]{Transformador Perfecto}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org731ea40}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:org2393657}]{Relaciones de Transformación}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org943a700}]{Transformador Ideal}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoIdealVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf2f93c4}]{Relación de Transformación del Transformador Ideal}
\begin{center}
...
\begin{frame}[label={sec:org5ee7627}]{Impedancia de Entrada}
\begin{center}
...
\begin{frame}[label={sec:org4ac2dae}]{Impedancia de Entrada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge143f3f}]{Circuito Equivalente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrafoIdealVariosDevanados_Impedancia.pdf}
...
\begin{frame}[label={sec:org78c12ec}]{Circuito Equivalente de un Transformador Perfecto}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5e778fe}]{Circuito Equivalente de un Transformador Perfecto}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/TrafoPerfectoIdealVariosDevanados_Impedancia.pdf}
...
\label{sec:org1bf2bef}
\begin{frame}[label={sec:org337d87f}]{Autotransformador Perfecto}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/AutotrafoPerfecto.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgecf0290}]{Ecuaciones del Autotransformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd9895c4}]{Circuito Alternativo del Autotransformador Perfecto}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/AutotrafoPerfecto2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgafd90ba}]{Ecuaciones del Circuito Alternativo}
\begin{center}
...
\begin{frame}[label={sec:org756d636}]{Ecuaciones Comparadas}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgfa9764e}]{Transformador Perfecto Equivalente}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org10d5c41}]{Transformador Perfecto Equivalente}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org14f2857}]{Autotransformador Ideal}
\begin{columns}
