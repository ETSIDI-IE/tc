...
\begin{frame}[label={sec:org07641dd}]{Recordatorio}
\begin{columns}
...
\label{sec:orgba064ff}

\begin{frame}[label={sec:orgb295bf0}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orgf64045d}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org26ddad0}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\label{sec:org4910688}
\begin{frame}[label={sec:org9c93e2c}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orge523633}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org9557b0a}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org1c7058f}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:org8199fd2}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org42e9e46}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:orgfb2fa7a}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgfad709a}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf997b5a}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgaf6c0b4}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1482931}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfd1317f}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc3f0035}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\label{sec:org7e78c24}
\begin{frame}[label={sec:org5da8be8}]{Definición}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgdc82129}]{El flujo en cada bobina es nulo}
...
\label{sec:org8ef74d5}
\begin{frame}[label={sec:orgcb42c87}]{Fuente de Tensión de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgbe44c29}]{Fuente de Tensión de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org2d773b0}]{Fuente de Corriente de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgc8de5f2}]{Fuente de Corriente de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf8c9c76}]{Impedancia de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org49b2d53}]{Impedancia de Primario a Secundario}
\begin{center}
...
\label{sec:org8852da1}
\begin{frame}[label={sec:org3bd7910}]{Recordatorio: impedancia de entrada de un T. Perfecto}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org2f4dfb7}]{Circuito equivalente con transformador ideal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org947530c}]{Recordatorio: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\begin{frame}[label={sec:orga791273}]{Equivalente en primario con transformador ideal}
\[
  \overline{Z}_{th} = \frac{1}{a^2} \cdot \frac{j \omega L_1 \cdot \overline{Z}_g}{j\omega L_1 + \overline{Z}_g}
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org035b442}]{Equivalente en secundario con transformador ideal}
\[
...
\label{sec:orgf46cfcd}
\begin{frame}[label={sec:org6bb9da3}]{Transformador Real de Varios Devanados}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org30c659f}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:org9cabd47}]{Transformador Perfecto}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdbb1124}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:org123d06b}]{Relaciones de Transformación}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org009232a}]{Transformador Ideal}
\begin{center}
...
\begin{frame}[label={sec:org74d8336}]{Ecuaciones del Circuito Alternativo}
\begin{center}
