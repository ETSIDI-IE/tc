...
\label{sec:org01d1de2}
\begin{frame}[label={sec:orgc0e9076}]{Forma de Onda}
\begin{itemize}
...
\begin{frame}[label={sec:org69b3e6a}]{Escalón}
\begin{columns}
...
\begin{frame}[label={sec:org35285f5}]{Escalón desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org84734fc}]{Pulso}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6db7000}]{Pulso desplazado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org79d2721}]{Rampa}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8bd17a1}]{Rampa desplazada}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org61376fb}]{Triangular}
\begin{columns}
...
\begin{frame}[label={sec:org1846a75}]{Triangular desplazada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\label{sec:orgec27348}
\begin{frame}[label={sec:org743ca23}]{Circuitos Lineales}
\begin{itemize}
...
\label{sec:org51106d0}

\begin{frame}[label={sec:orgd98ab98}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org1388b1d}]{Análisis de un circuito mediante proporcionalidad}
...
\begin{frame}[label={sec:orgd23bda5}]{Análisis de un circuito mediante proporcionalidad}
...
\label{sec:orge68c94c}

\begin{frame}[label={sec:orgb78dd84}]{Aditividad o Superposición}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org9a54a5b}]{Análisis de un circuito mediante superposición}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcd20b8b}]{Observaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org66b3cfb}]{Potencia}
...
\begin{frame}[label={sec:orge944dee}]{Potencia}
\begin{itemize}
...
\label{sec:orgea7321d}

\subsection{Teoremas}
\label{sec:org10a7dd3}

\begin{frame}[label={sec:org5875cd1}]{Thévenin}
...
\begin{frame}[label={sec:orgd037033}]{Norton}
...
\subsection{Cálculo}
\label{sec:org39b1242}
\begin{frame}[label={sec:orgcf3da09}]{Cálculo del equivalente de Thévenin}
\begin{center}
...
\begin{frame}[label={sec:orgb5e6a1d}]{Cálculo del equivalente de Norton}
\begin{center}
...
\begin{frame}[label={sec:org50d3627}]{Observaciones}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3ce59e0}]{Recordatorio: equivalencia de fuentes}
...
\label{sec:org2bea67f}

\begin{frame}[label={sec:org852a237}]{Planteamiento}
...
\subsection{Cálculo}
\label{sec:orgc3cdf83}
\begin{frame}[label={sec:org62e9736}]{Ecuaciones}
...
\begin{frame}[label={sec:orge6600a8}]{Reactancia}
...
\begin{frame}[label={sec:org99940ab}]{Resistencia}
...
\label{sec:org1a78042}

\begin{frame}[label={sec:org40bdaa7}]{Impedancia de Carga}
...
\begin{frame}[label={sec:orgd674392}]{Máxima potencia disponible\}}
