...
\label{sec:orgd43b806}

\begin{frame}[label={sec:org1c54921}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org28c467d}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org6d1faf5}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org674c8dc}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org5198e8c}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org91d09a6}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orge42b4b5}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\begin{frame}[label={sec:org58621c2}]{Cálculo de potencia}
\end{frame}

\section{Teoremas de reciprocidad, sustitución y compensación}
\label{sec:org5586669}

\begin{frame}[label={sec:orgff6db1e}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orgcf788e0}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orge68dc0e}]{Teorema de sustitución}
\end{frame}

\begin{frame}[label={sec:orgc604534}]{Teorema de compensación}
\end{frame}

\section{Teorema de Rosen}
\label{sec:orgd70509a}

\section{Teorema de Millman}
\label{sec:org1d8efe9}

\section{Teoremas de Thévenin/Norton}
\label{sec:org068e731}

\begin{frame}[label={sec:org6694ae6}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgc23c134}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgb3bfea6}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org0328d34}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org507ab26}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org864c06e}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orga49ae72}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org3d2b1ba}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org992cf60}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org747f2dc}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org46581b7}]{Máxima Transferencia de Potencia}
...
\label{sec:org3b5d277}

\section{Teorema de Tellegen}
\label{sec:org448dd34}
\end{document}