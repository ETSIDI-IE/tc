...
\label{sec:org1c340ef}

\begin{frame}[label={sec:orgede737e}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:org5a0207c}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:orgfc6be50}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org97db2fa}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org748248c}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org92fac31}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org3b26ab8}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\label{sec:org624abb5}

\begin{frame}[label={sec:orgcedc0f1}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:org435be75}]{Teorema de reciprocidad}
...
\begin{frame}[label={sec:orga18591c}]{Teorema de sustitución}
\begin{center}
...
\label{sec:orga7ba69f}

\begin{frame}[label={sec:orga15e5cb}]{Planteamiento}
...
\begin{frame}[label={sec:org78dc1a9}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga611fe8}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0e4c61b}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:org98cdc7a}]{Solución}
...
\begin{frame}[label={sec:orgfb7d7a3}]{Planteamiento}
...
\begin{frame}[label={sec:orgeefe357}]{Resolución}
La tensión \(u_{AO}\) es:
\[
  u_{AO} = u_{Aj} + i_j/Y_j
\]
...
\begin{frame}[label={sec:org7819fdc}]{Aplicación}
...
\label{sec:orgdc26e9c}

\begin{frame}[label={sec:org66c01e8}]{Planteamiento}
...
\begin{frame}[label={sec:orgdfd56a5}]{Corrientes en el polígono}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs/Rosen_D.pdf}
...
\begin{frame}[label={sec:org16a0403}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgd7f7ae6}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgd9bc572}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org5557197}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgc0071a3}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org8687ab9}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org177edc2}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org0a31518}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org40acfbb}]{Máxima Transferencia de Potencia}
...
\label{sec:org4fceb38}

\begin{frame}[label={sec:org090f389}]{Planteamiento}
...
\begin{frame}[label={sec:org24fd396}]{Potencia}
...
\begin{frame}[label={sec:orge77ed2d}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org5c020f3}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org5f041e5}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:orge583e4e}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:orge13f780}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org69e5678}]{Pérdidas de transmisión}
...
\begin{frame}[label={sec:orgf130b97}]{Pérdidas de inserción}
