...
\label{sec:org90426da}

\begin{frame}[label={sec:org657b3a5}]{Elementos lineales}
\begin{itemize}
...
\begin{frame}[label={sec:orgebe0f1d}]{Homogeneidad o Proporcionalidad}
...
\begin{frame}[label={sec:org055a5ae}]{Teorema de superposición}
\begin{columns}
...
\begin{frame}[label={sec:org21e1e83}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org05e4b8c}]{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org03e7780}]{Cálculo de potencia con superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org13e8446}]{Cálculo de potencia con superposición}
\begin{itemize}
...
\begin{frame}[label={sec:org7d7d0ee}]{Teorema de sustitución}
\begin{center}
...
\label{sec:org5125084}

\begin{frame}[label={sec:org6ad6358}]{Planteamiento}
...
\begin{frame}[label={sec:org632d29a}]{Aplicamos teorema de sustitución}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgeed66af}]{A continuación, teorema de superposición}
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/TeoremaCompensacion2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd608d8e}]{Nuevamente, teorema de sustitución}
...
\begin{frame}[label={sec:orga4250ea}]{Solución}
...
\label{sec:orga08e54c}

\begin{frame}[label={sec:orgbd020ef}]{Planteamiento}
...
\begin{frame}[label={sec:org4a57361}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org7e1f1e3}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orga32c98b}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org6aed5ae}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgd6a207c}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org86cf103}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org26be3eb}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgd2ba855}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org3eaf857}]{Máxima Transferencia de Potencia}
...
\label{sec:orgb8eefdf}

\begin{frame}[label={sec:org09b6d0b}]{Planteamiento}
...
\begin{frame}[label={sec:org0905209}]{Potencia}
...
\begin{frame}[label={sec:org4018bde}]{Diseño de redes adaptadoras}
...
\begin{frame}[label={sec:org051b950}]{Diseño de redes adaptadoras: \(R_g > R_L\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org22d864e}]{Diseño de redes adaptadoras: \(R_L > R_g\)}
\begin{columns}
\begin{column}{0.3\columnwidth}
Condición:
\[
...
\begin{frame}[label={sec:org2597ac7}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org16f3f74}]{Pérdidas de transmisión e inserción}
...
\begin{frame}[label={sec:org9faca53}]{Pérdidas de transmisión}
