...
\label{sec:org35120ca}

\begin{frame}[label={sec:org3c32b61}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:orgee4ee0e}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org7dd9b43}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:org46eae33}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:orgf05214a}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:orgb5cf49c}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:orgad4f844}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2000a5}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:org22d644a}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0bd5501}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:orgfd06a08}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:org1b8e6df}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:org79ea8e4}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orgda57816}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd805ad3}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4b33681}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:org3546f1f}
\begin{frame}[label={sec:org904f6ba}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd346ebb}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org976364c}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:orgc54b5f3}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:orgae98e23}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:orgd0970e5}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:org46c7806}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:org01b37d0}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org5c9a5db}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org54f1d94}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8b3fa71}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orgf6f5332}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org3276c5e}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orga49a6f5}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org6d5df13}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:orgdda7767}]{Medida de potencia}
\begin{center}
...
\label{sec:orgc40e437}

\begin{frame}[label={sec:org55e8da4}]{Factor de potencia}
...
\begin{frame}[label={sec:org662f2a5}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgeaff187}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd508999}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:orgfaf248e}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:orga2a609e}]{Cálculo de la Capacidad}
\begin{center}
