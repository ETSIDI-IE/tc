...
\label{sec:org4ee53fc}

\begin{frame}[label={sec:org3b00d6f}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:orga661788}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:orgae10864}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org3124f85}]{Valor medio y valor eficaz}
...
\label{sec:orgf1684b5}

\begin{frame}[label={sec:org6f40e2c}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:orgd4165f9}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:org879e38c}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:orgca2b71b}]{Impedancia Genérica}
\[
\overline{Z} = R + j X
\]
...
\begin{frame}[label={sec:org5796318}]{Circuito Resistivo}
...
\begin{frame}[label={sec:orgb50ae23}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
\begin{center}
...
\begin{frame}[label={sec:orga7c7c15}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:org9e2bc52}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org7bcdf70}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:org0bcc892}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:orgbf5ff79}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org4e4546a}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdb654fa}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:org76a4ddb}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:orgf80b1cb}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2d285dd}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:org6880a98}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:orge0f4a0b}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:org2d9c8a2}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:org0849945}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:org73b14fb}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9e5873b}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:orgb61706e}
\begin{frame}[label={sec:org3354059}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb4c7ac7}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org1367dfd}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:org114eb87}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:org6ce8de8}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org0198a0d}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:orgf1df968}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgcc8451d}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\theta} \quad%
     Q = UI\sin\theta
   \]
...
\begin{frame}[label={sec:org8ac218c}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgbe2ab1d}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org70113ab}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org80544b2}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org71fcf79}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orgd588200}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org8526150}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org5af64b0}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org8694018}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:org60aa933}]{Medida de potencia}
\begin{center}
...
\label{sec:org1ec929c}

\begin{frame}[label={sec:org2e73ac7}]{Factor de potencia}
...
\begin{frame}[label={sec:org1871bff}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org664bcd7}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org811f28e}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:org9f83c90}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org9dc7860}]{Cálculo de la Capacidad}
\begin{center}
