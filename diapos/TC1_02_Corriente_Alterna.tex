...
\label{sec:org700be71}

\begin{frame}[label={sec:orgc6fbe5b}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:org874381f}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org2a48327}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org91077d7}]{Valor medio y valor eficaz}
...
\label{sec:org837212c}

\begin{frame}[label={sec:orgb402c66}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:orge9728bf}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:orgf1b784f}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org3f4dc1b}]{Impedancia Genérica}
\[
\overline{Z} = R + j X
\]
...
\begin{frame}[label={sec:org4eb1895}]{Circuito Resistivo}
...
\begin{frame}[label={sec:org3bc574d}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
\begin{center}
...
\begin{frame}[label={sec:orga0b1f4f}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:orge403092}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org432228c}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:org6b7550c}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:org4fea07f}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org1277650}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5720ed4}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd9e1115}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:orge56e82b}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org95895cf}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:orgff1ba77}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:org0f83d90}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:org0cbf6eb}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orgc77697e}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:org8026701}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd89b8c1}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:orgac039b9}
\begin{frame}[label={sec:orgb956fbb}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgdf0dba7}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org1ffd278}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:org1c3f738}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:orgc73a3e6}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org137bdf9}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:org27f49b2}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:org6bc32c7}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\theta} \quad%
     Q = UI\sin\theta
   \]
...
\begin{frame}[label={sec:org63538c8}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:org2daa3f0}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org04b7823}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:org8ab0a7a}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org4b20bec}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgb0ab933}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org477be12}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:orga3e2644}]{Medida de potencia}
\begin{center}
...
\label{sec:org6ee12a4}

\begin{frame}[label={sec:orgbbfd9f3}]{Factor de potencia}
...
\begin{frame}[label={sec:org6dac9eb}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orga116f7b}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org7a4388d}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:org03fbb80}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:orgb494e83}]{Cálculo de la Capacidad}
\begin{center}
