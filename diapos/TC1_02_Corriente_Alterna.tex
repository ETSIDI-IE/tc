...
\label{sec:orgad5c095}

\begin{frame}[label={sec:org24fe4e7}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:org1f3fdf1}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org9592147}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org7ab7b69}]{Valor medio y valor eficaz}
...
\label{sec:orgaa185da}

\begin{frame}[label={sec:org5b8ad26}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:orgefc0a91}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:org763f3b5}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org3e914c2}]{Impedancia Genérica}
\[
\overline{Z} = R + j X
\]
...
\begin{frame}[label={sec:org926688f}]{Circuito Resistivo}
...
\begin{frame}[label={sec:org0c66ba2}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
...
\begin{frame}[label={sec:orgb051e61}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:org686f6f6}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org64133ba}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:org6273b83}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:org9c51056}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org690faf3}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc247663}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:orgeb9f59c}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org490383e}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb4304d3}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:org2669dcb}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:org268b197}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd8da53d}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orga3048c7}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:orge0fd125}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org24b205d}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:org1fd71a8}
\begin{frame}[label={sec:orgcc72961}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgbc7194d}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org5c0e169}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:orgec7abc0}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:org657f7fe}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org058359e}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:org4619c74}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgbf9f70b}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\theta} \quad%
     Q = UI\sin\theta
   \]
...
\begin{frame}[label={sec:org430c744}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgbfe8a85}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org88e0701}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org019b729}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd337968}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orgc347a61}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org70a64dd}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgb0a36ac}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org198837b}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:orgda3fd9d}]{Medida de potencia}
\begin{center}
...
\label{sec:org266b67a}

\begin{frame}[label={sec:orgb8a1458}]{Factor de potencia}
...
\begin{frame}[label={sec:orge00b069}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org393a079}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc663cd3}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:org785eecd}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org76c4dad}]{Cálculo de la Capacidad}
\begin{center}
