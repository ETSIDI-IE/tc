...
\label{sec:orge9cfa1f}

\begin{frame}[label={sec:orgab72311}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:orgb0c9791}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:orgcd75dbf}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org7661adf}]{Valor medio y valor eficaz}
...
\label{sec:org83d90b7}

\begin{frame}[label={sec:org87dac00}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:org85b0450}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:orgb43c3a2}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org7a60409}]{Impedancia Genérica}
\[
\overline{Z} = R + j X
\]
...
\begin{frame}[label={sec:org8b79229}]{Circuito Resistivo}
...
\begin{frame}[label={sec:org6a418bc}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
\begin{center}
...
\begin{frame}[label={sec:org565476c}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:org719952b}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org4e533c5}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:orge910222}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:org909c376}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org902e50e}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org469c517}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:orgdd7ff3c}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:orge6e6ef6}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0f02971}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:orgfa32f15}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:orgf82b500}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:org0e2b629}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orgffe7438}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:orgbca48b3}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5e0ec01}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:orga7624a5}
\begin{frame}[label={sec:org506459e}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgaea00af}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org805a458}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:orgcf36bac}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:org3503c6d}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:orgdd3d3fd}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:orgc783b00}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:org9c644ef}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\theta} \quad%
     Q = UI\sin\theta
   \]
...
\begin{frame}[label={sec:org172a8b0}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:org4234597}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org75d43ed}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org7b8c688}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd7897ee}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orge1f061b}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org5191571}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org100eade}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org6415225}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:orgb858bd9}]{Medida de potencia}
\begin{center}
...
\label{sec:orge7ee1f2}

\begin{frame}[label={sec:orgfc5ac85}]{Factor de potencia}
...
\begin{frame}[label={sec:org2009e10}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orge035b19}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org8dc6773}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:orga00d4e0}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org966e5e8}]{Cálculo de la Capacidad}
\begin{center}
