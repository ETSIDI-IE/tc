...
\label{sec:orgd071381}

\begin{frame}[label={sec:org279a2aa}]{Onda sinusoidal}
\begin{center}
...
\begin{frame}[label={sec:orga6a67ca}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org9f7c466}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:org743f746}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:org3981802}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org53cceb6}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org3986999}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:orgcd180cb}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org857be7e}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:org2d2eb16}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdc46120}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:orge4a3ae5}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:org9be5939}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:orgefe5e76}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:org6006627}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:org4d7174a}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc07bd3f}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:orgea869fb}
\begin{frame}[label={sec:org4c6824f}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd4b5135}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org1a8e1d7}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:org4f75156}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:orga490253}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org1b67d8c}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:orge8ac1f9}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgc4bd6f7}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:orgbb8e0ed}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org16308dc}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8263117}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:org58b2ecc}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgf54bc4f}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgf08a51c}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org7a056ce}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:org8c05149}]{Medida de potencia}
\begin{center}
...
\label{sec:orgf37c685}

\begin{frame}[label={sec:orga820c2d}]{Factor de potencia}
...
\begin{frame}[label={sec:orgf76347a}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org62cd625}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb89fc22}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:org4248a7f}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org726a946}]{Cálculo de la Capacidad}
\begin{center}
