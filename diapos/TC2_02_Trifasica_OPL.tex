...
\begin{frame}[label={sec:org7c070f3}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org90f5730}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org7787e74}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org7b8d5ab}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\begin{frame}[label={sec:org796809c}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd3b43e5}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\label{sec:org72038a1}
\begin{frame}[label={sec:org86680c8}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org0b33d77}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgfeed65b}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1f18088}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org877e9ee}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
