...
\section{Generadores}
\label{sec:org99e8f62}
\begin{frame}[label={sec:org8415167}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgda81523}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org56b1a4b}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org1a74eb4}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org2813971}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orgff91199}
\begin{frame}[label={sec:org0640e45}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org62206c2}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9137be6}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf9b86f9}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2ae66ec}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8ab5f81}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org81a1d8d}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga165484}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:org2ac729b}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgf763d20}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgab16c6b}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org1c34099}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org23f985e}]{Transformación de receptores}
...
\begin{frame}[label={sec:org02cbd9e}]{Transformación de receptores}
...
\label{sec:orgef682e9}

\begin{frame}[label={sec:org22a6d97}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org11190b2}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org04dffab}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org3f89ae6}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:orgd4a7002}

\begin{frame}[label={sec:orga4baf10}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc0e22ba}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org16efe75}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgbfc6455}
\begin{frame}[label={sec:orgc87df61}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org696a8a4}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orge861f63}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org208d41b},plain]{Sistema de 3 Hilos Equilibrado (SFD)}
\[
...
\begin{frame}[label={sec:orgaf4bc3b},plain]{Sistema de 3 Hilos Equilibrado (SFI)}
\[
...
\begin{frame}[label={sec:org072131a}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgde71c72}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga6eff0b}]{Medida de la reactiva con receptor desequilibrado}
\begin{center}
...
\label{sec:org317f15c}

\begin{frame}[label={sec:orgedf3c26}]{Estrella a Triángulo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealEstrella.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5c486a2}]{Transformamos impedancia}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org14cd6c4}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_ZTriangulo.pdf}
...
\begin{frame}[label={sec:org77d66d7}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_Transformado1.pdf}
...
\begin{frame}[label={sec:org07b4756}]{Triángulo a Estrella}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealTriangulo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5d925b7}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd0ce029}]{Transformamos impedancias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I.pdf}
...
\begin{frame}[label={sec:org0c96a77}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I_ZEstrella.pdf}
...
\begin{frame}[label={sec:org54af742}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado1.pdf}
...
\begin{frame}[label={sec:org956d358}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado2.pdf}
...
\label{sec:org0ee8c5b}
\begin{frame}[label={sec:orgbb411ea}]{Planteamiento del sistema}
\begin{center}
...
\begin{frame}[label={sec:org63909d1}]{Agrupamos impedancias de generador, línea y receptor}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7e83ba5}]{Conversión de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge61b9b7}]{Tensión de desplazamiento del neutro}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CircuitoTrifasicaGeneralizado3.pdf}
...
\begin{frame}[label={sec:org2904616}]{Cálculo de corrientes}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CircuitoTrifasicaGeneralizado.pdf}
...
\begin{frame}[label={sec:orgbeb0aaf}]{Aplicación a sistemas equilibrados}
...
\begin{frame}[label={sec:org0a6430f}]{Aplicación a sistemas desequilibrados}
\begin{itemize}
...
\begin{frame}[label={sec:org540f2ce}]{Sistema sin neutro}
\begin{center}
...
\begin{frame}[label={sec:org7f3b9a0}]{Receptor en triángulo}
\begin{center}
...
\begin{frame}[label={sec:orgfc19dea}]{Generador en triángulo}
\begin{center}
...
\begin{frame}[label={sec:org8390963}]{Generador y Receptor en triángulo}
\begin{center}
