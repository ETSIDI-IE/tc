...
\begin{frame}[label={sec:org4ac6ff6}]{Análisis de Circuitos en Ingeniería (\alert{HKD})}
\begin{block}{Datos}
\begin{itemize}
...
\begin{frame}[label={sec:orgc790687}]{Fundamentos de Circuitos Eléctricos (\alert{AS})}
\begin{block}{Datos}
\begin{itemize}
...
\begin{frame}[label={sec:org8c495bb}]{Circuitos Eléctricos (\alert{PO})}
\begin{block}{Datos}
\begin{itemize}
