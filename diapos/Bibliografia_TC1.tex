...
\begin{frame}[label={sec:org9abde96}]{Análisis de Circuitos en Ingeniería (\alert{HKD})}
\begin{block}{Datos}
\begin{itemize}
...
\begin{frame}[label={sec:orga16bd47}]{Fundamentos de Circuitos Eléctricos (\alert{AS})}
\begin{block}{Datos}
\begin{itemize}
...
\begin{frame}[label={sec:org9f8b8aa}]{Circuitos Eléctricos (\alert{PO})}
\begin{block}{Datos}
\begin{itemize}
