...
\label{sec:orgd39f2c0}
\begin{frame}[label={sec:org78770b2}]{Tensión Eléctrica}
...
\end{frame}
\begin{frame}[label={sec:orgc283148}]{La trayectoria no importa}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf76ee25}]{El signo depende del sentido}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org4ad1f3a}]{Corriente Eléctrica}
...
\end{frame}
\begin{frame}[label={sec:org53bec88}]{Potencia Eléctrica}
...
\end{frame}
\begin{frame}[label={sec:org92d3a8c}]{Signo de la potencia eléctrica}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgacaeb23}]{Receptores y Generadores}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2adea24}]{Potencia y Energía}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org7499e58}]{Rendimiento/Eficiencia}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf9f0669}]{Resistividad}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga742ee8}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\label{sec:org17efe36}

\subsection{Definiciones}
\label{sec:org5463ce4}
\begin{frame}[label={sec:org21aa3e6}]{Nudo, rama, malla}
\begin{description}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0b7f4f6}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org1646e8e}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge2af816}]{Equivalencia de Fuentes}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5205e20}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org63f02d1}

\begin{frame}[label={sec:orge978aad}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbd7a99c}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf42a650}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4aa49f7}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org03a53f5}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6395df7}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd12aa70}]{Dos resistencias en paralelo}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org874da6d}]{Conductancia}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org7c1b901}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AsociacionParalelo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf12da70}]{Conexión en paralelo de inductancias}
\begin{center}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org20cb24b}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga469546}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org87e68d9}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5af207b}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org624f465}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5807d1f}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgbdb1217}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd61cb0e}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org51be9fa}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:orgf917397}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8e47d0c}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb8a3902}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org3a6008a}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org5617642}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgd1de007}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org5a720a3}]{Procedimiento}
\begin{enumerate}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org245909a}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
