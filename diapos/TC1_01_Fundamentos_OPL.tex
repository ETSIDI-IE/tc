...
\begin{frame}[label={sec:org51421d8}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:orge4f0f99}]{Sistemas lineales}
...
\begin{frame}[label={sec:org91d7b43}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:orgb72b205}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge5d384c}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:orgbceb295}
\begin{frame}[label={sec:org0d789d1}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org8c186fa}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org7fbc419}]{El signo depende del sentido}
...
\begin{frame}[label={sec:org986f2aa}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:orgaa74861}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:org9742ab2}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org21df76e}]{Receptores y Generadores}
...
\begin{frame}[label={sec:org03a4b3c}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org874186e}]{Rendimiento/Eficiencia}
...
\begin{frame}[label={sec:orgb05cd16}]{Corriente Continua y Corriente Alterna}
\begin{itemize}
...
\label{sec:orgea1d226}

\subsection{Elementos Pasivos}
\label{sec:org9b027fd}
\begin{frame}[label={sec:org96aaef7}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org92c3a4c}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org225c5c1}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org192e71f}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org746840f}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org0d8544d}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:orgb6829fe}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org3cf80ca}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Condensador.pdf}
\end{center}
...
\label{sec:orgad238d2}


\begin{frame}[label={sec:org6497271}]{Generador Ideal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc874263}]{Generador Real}
...
\label{sec:orge069ce0}

\begin{frame}[label={sec:org021cc14}]{Generadores de Tensión}
\begin{columns}
\begin{column}{0.5\columnwidth}
  \begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf2bf1d1}]{Generadores de Corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
 \begin{center}
...
\label{sec:orgb4d53ee}

\subsection{Definiciones}
\label{sec:org4bc4b1a}
\begin{frame}[label={sec:org15620ae}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org183c28a}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgc7f9258}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org6cb5e5e}]{Balance de Tensiones}
\begin{center}
...
\begin{frame}[label={sec:org8e4852f}]{Balance de Tensiones}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb15de23}]{Generador y Receptor}
\begin{center}
\includegraphics[height=0.25\textheight]{../figs/circuito_lkv.pdf}
\end{center}
...
\label{sec:org012b014}

\begin{frame}[label={sec:org4ba15cb}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:orgafe5ff9}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:orgad143f9}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org827c642}

\begin{frame}[label={sec:org61d59cb}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5189355}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:orgda99ad1}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org383668c}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge55e1a6}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org12d394a}]{Conexión en serie de generadores}
...
\begin{frame}[label={sec:orgc06e3a8}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgcbb456f}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge7a99ec}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orge28b4c0}]{Conductancia}
...
\begin{frame}[label={sec:org9d6720e}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orge26ef5c}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:org2c06388}]{Conexión en paralelo de condensadores}
\begin{center}
...
\begin{frame}[label={sec:org4012bec}]{Conexión en paralelo de generadores}
\begin{block}{Generadores de Tensión}
\begin{itemize}
...
\begin{frame}[label={sec:org7a84239}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbf4db58}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4c157b0}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4b8e34d}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf0fc1be}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb36b0ff}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb64ffbe}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\label{sec:org6e6d7ef}

\subsection{Método de las mallas}
\label{sec:org4f3d6df}

\begin{frame}[label={sec:orgee92433}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org964d48c}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org336c4a3}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\begin{frame}[label={sec:org7764ca9}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaaa4dc2}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:org09179f6}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org14acbb2}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2bbeeea}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgeda1dae}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org40dd854}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org293a508}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgece1ed0}]{Procedimiento}
\begin{enumerate}
...
\label{sec:org0b39b2f}
\begin{frame}[label={sec:org7605cfd}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org918bb54}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org9ef9289}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgfb5bc26}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org45f1cf2}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org0676bb4}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org579a09c}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\begin{equation*}
...
\begin{frame}[label={sec:org1c2b5cc}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
