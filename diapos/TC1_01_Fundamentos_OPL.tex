...
\begin{frame}[label={sec:org9b42238}]{Análisis y Diseño}
...
\end{frame}
\begin{frame}[label={sec:org19f0d32}]{Sistemas lineales}
...
\begin{frame}[label={sec:orgf77a5cf}]{La linealidad es una aproximación de la realidad}
\begin{itemize}
...
\begin{frame}[label={sec:orge1d17a9}]{Parámetros concentrados}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2b6724b}]{Simplificación de las ecuaciones de Maxwell}
\begin{itemize}
...
\label{sec:org21b4b45}
\begin{frame}[label={sec:orge5d6d05}]{Tensión Eléctrica}
...
\begin{frame}[label={sec:org07c29ef}]{La trayectoria no importa}
...
\begin{frame}[label={sec:org0de1874}]{El signo depende del sentido}
...
\begin{frame}[label={sec:orgba59695}]{Corriente Eléctrica}
...
\begin{frame}[label={sec:org5c7e26b}]{Potencia Eléctrica}
...
\begin{frame}[label={sec:orge19365d}]{Signo de la potencia eléctrica}
...
\begin{frame}[label={sec:org17bb08c}]{Receptores y Generadores}
...
\begin{frame}[label={sec:orgf2eae63}]{Potencia y Energía}
\begin{description}
...
\begin{frame}[label={sec:org8566ff4}]{Rendimiento/Eficiencia}
...
\label{sec:org11971ab}
\begin{frame}[label={sec:orgeed7f1d}]{Resistencia}
\begin{itemize}
...
\begin{frame}[label={sec:org1e5dad8}]{Resistividad}
\begin{itemize}
...
\begin{frame}[label={sec:org691b7ef}]{Cortocircuito y Circuito Abierto}
\begin{itemize}
...
\begin{frame}[label={sec:org4c9e109}]{Ley de Joule}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org39ec7d6}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:orgdc1aa09}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org488759a}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:org30915ae}]{Generador Ideal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org44b7077}]{Generador Real}
...
\label{sec:org85b0a4a}

\subsection{Definiciones}
\label{sec:org66c3f80}
\begin{frame}[label={sec:org39f81f7}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org3e8f636}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org5a43d0b}]{Ecuación del generador}
Los generadores reales tienen pérdidas que se modelan con una resistencia en \alert{serie} (generador de tensión) o en \alert{paralelo} (generador de corriente)
...
\begin{frame}[label={sec:org2b4eb06}]{Equivalencia de Fuentes}
\begin{columns}
...
\begin{frame}[label={sec:org33f6356}]{Equivalencia de Fuentes}
\begin{columns}
\begin{column}{0.25\columnwidth}
\begin{center}
...
\label{sec:org2a70cf1}

\begin{frame}[label={sec:org2187010}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2d36bff}]{Conexión en serie}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\begin{frame}[label={sec:org3d06c3e}]{Divisor de Tensión}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[height=0.85\textheight]{../figs/AsociacionSerie.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge758717}]{Conexión en serie de inductancias}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd4b015f}]{Conexión en serie de condensadores}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1dd3a46}]{Conexión en paralelo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orga7cc401}]{Conexión en paralelo}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org753bdbf}]{Dos resistencias en paralelo}
...
\begin{frame}[label={sec:orgdfa47fa}]{Conductancia}
...
\begin{frame}[label={sec:orge9a23fe}]{Divisor de corriente}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AsociacionParalelo.pdf}
...
\begin{frame}[label={sec:orge34198d}]{Conexión en paralelo de inductancias}
\begin{center}
...
\begin{frame}[label={sec:orgfed6c5a}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3f8bcff}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3e0b9e1}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0712d1b}]{Conexión Estrella - Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc7b507f}]{Conexión Estrella - Triángulo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgc93b0b9}]{Conversión de Triángulo a Estrella}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Triangulo.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc00bad2}]{Conversión de Estrella a Triángulo}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Conexion_Estrella.pdf}
...
\label{sec:orga8bf8d4}

\subsection{Método de las mallas}
\label{sec:orgee47efc}

\begin{frame}[label={sec:org6f52cc3}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf878dd4}]{Aplicamos LKC}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7ac2b3f}]{Aplicamos LKV}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\begin{frame}[label={sec:org56fbcae}]{Combinamos las ecuaciones}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/mallas1.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8364231}]{Y las expresamos en forma matricial}
\begin{equation*}
  \begin{bmatrix}
    -1 & -1 & 0 & 0 & 0 & 1\\
    1 & 0 & 1 & 0 & 1 & 0\\
...
\end{frame}
\begin{frame}[label={sec:orgbf05d62}]{Método de las mallas}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5c1bd53}]{Relaciones entre las corrientes de rama y malla}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf34003e}]{Ecuaciones de malla}
\begin{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org1e2f583}]{Reagrupamos corrientes en las ecuaciones}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org35ccb52}]{Y lo expresamos en forma matricial}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org2fc6568}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org232c8a3}]{Procedimiento}
\begin{enumerate}
...
\label{sec:org97f8c29}
\begin{frame}[label={sec:orga2cd0ec}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb96ba02}]{Aplicamos LKC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org3a7fef4}]{Tensiones en las resistencias}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org8d6cb5f}]{Despejamos las corrientes}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org777f710}]{Combinamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:org9cb7132}]{Reorganizamos las ecuaciones}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd01ae32}]{Expresión matricial}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudos.pdf}
\end{center}
\begin{equation*}
