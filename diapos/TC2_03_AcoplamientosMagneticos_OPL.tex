...
\section{Bobina}
\label{sec:orgee5f501}

\begin{frame}[label={sec:org7439aaa}]{Ley de Ampere}
...
\begin{frame}[label={sec:orgc8124ea}]{Ley de Faraday}
...
\begin{frame}[label={sec:org2ad8a6d}]{Bobina}
...
\begin{frame}[label={sec:org7b0e20a}]{Bobina}
...
\label{sec:orgc10b74d}
\begin{frame}[label={sec:orgcaaa4f1},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/acoplamientoTikz.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org084d26c},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org87e2ca6},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org7823d42},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
...
\begin{frame}[label={sec:orgf6e2b07}]{Coeficiente de acoplamiento magnético}
\begin{center}
...
\label{sec:org998452e}
\begin{frame}[label={sec:org4e8b3bc}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orge23b588}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd45cde2}]{Flujos contrapuestos}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org9b2e4d9}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
induce una tensión positiva en el otro terminal con punto.
\end{frame}
\begin{frame}[label={sec:org6d6c4f7}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\begin{frame}[label={sec:org4c445d8}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6aba349}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org3269e67}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org058d536}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
