...
\section{Bobina}
\label{sec:org92866f7}

\begin{frame}[label={sec:org0d3af2f}]{Ley de Ampere}
...
\begin{frame}[label={sec:org692c596}]{Ley de Faraday}
...
\begin{frame}[label={sec:org69454c0}]{Bobina}
...
\begin{frame}[label={sec:org9576da6}]{Bobina}
...
\label{sec:org583f14c}
\begin{frame}[label={sec:org7ef2486},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/acoplamientoTikz.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb031596},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org7ad9513},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2f68565},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
...
\begin{frame}[label={sec:org7714d9d}]{Coeficiente de acoplamiento magnético}
\begin{center}
...
\label{sec:orgba364e7}
\begin{frame}[label={sec:org659fb79}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org76db1f6}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org13cb1b3}]{Flujos contrapuestos}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org6fa89e2}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
induce una tensión positiva en el otro terminal con punto.
\end{frame}
\begin{frame}[label={sec:orgb827b1b}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\begin{frame}[label={sec:org3d9a4c5}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgb84d41f}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org6b83e85}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf528f61}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
