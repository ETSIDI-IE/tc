...
\section{Bobina}
\label{sec:orgced3f10}

\begin{frame}[label={sec:org6a45598}]{Ley de Ampere}
...
\begin{frame}[label={sec:org96d3236}]{Ley de Faraday}
...
\begin{frame}[label={sec:org7624e74}]{Bobina}
...
\begin{frame}[label={sec:orgc9fd93c}]{Bobina}
\begin{itemize}
...
\label{sec:org0549261}
\begin{frame}[label={sec:orgf7d5e41},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/acoplamientoTikz.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgcc091ef},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgf1c2166},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4f1457b},plain]{}
\begin{columns}
\begin{column}{0.5\columnwidth}
\[
...
\begin{frame}[label={sec:org191798d}]{Coeficiente de acoplamiento magnético}
\begin{center}
...
\begin{frame}[label={sec:org625a8ec}]{Coeficiente de inducción mutua}
\begin{itemize}
...
\begin{frame}[label={sec:org98d3d44}]{Resumen}
\[
  L_1 = N_1 \frac{\phi_{11}}{i_1}
\]
...
\label{sec:org8682d1e}
\begin{frame}[label={sec:orgf87a705}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgf5f2065}]{Flujos del mismo sentido}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgcd489c9}]{Flujos contrapuestos}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org90cf2a3}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
induce una tensión positiva en el otro terminal con punto.
\end{frame}
\begin{frame}[label={sec:orgddbd2f7}]{Representación Circuital}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\begin{frame}[label={sec:orga5838f5}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org8542897}]{Corriente Alterna Sinusoidal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/acoplamientoTikz_opuesto.pdf}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org67c46f5}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org64d7063}]{Ejemplo: acoplamiento de bobinas en serie}
\begin{center}
