...
\begin{frame}[label={sec:orgf2d97bc}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:orgeea57a7}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org38178ef}]{Formas de Onda Periódicas}
\framesubtitle{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1b9490d}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org37ee2f6}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:org427b963}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org797dc7b}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org646577f}]{Circuito paralelo general}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orga367c53}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{../figs/Z.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org36bf797}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orgdc07764}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org513e3af}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org30f38ce}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org77c0115}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:orgb4078d7}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:orgf9aee95}]{Cálculo de la Capacidad}
\begin{center}
