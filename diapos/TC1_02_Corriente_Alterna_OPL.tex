...
\label{sec:org1214ac8}

\begin{frame}[label={sec:org4417076}]{Forma de Onda}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6354b8b}]{Clasificación}
...
\begin{frame}[label={sec:org13c0b87}]{Valores que definen una onda periódica}
...
\begin{frame}[label={sec:orgb5de15d}]{Valores que definen una onda periódica}
\begin{itemize}
...
\begin{frame}[label={sec:org2bb766b}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org7f077f3}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org36955b4}]{Formas de Onda Periódicas}
\framesubtitle{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8b5cf45}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org455330c}]{Formas de Onda Periódicas}
...
\label{sec:orgc56915d}

\begin{frame}[label={sec:orge8c3550}]{Definición}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/sin.pdf}
\end{center}
...
\begin{frame}[label={sec:org9a58be6}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:orgb0462f1}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org827bd82}]{Valor medio y valor eficaz}
\begin{block}{Valor medio}
\[
...
\label{sec:orge56f602}

\begin{frame}[label={sec:org863ba28}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:org0dba72f}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:orgbf0b4dc}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org338d23d}]{Impedancia Genérica}
\[
\overline{Z} = R + j X
\]
...
\begin{frame}[label={sec:org6dcaa4a}]{Circuito Resistivo}
...
\begin{frame}[label={sec:org2759ea4}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
\begin{center}
...
\begin{frame}[label={sec:org09a23a8}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:orgcaa41de}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org2097128}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:orgca5aa3a}]{Circuito Capacitivo puro}
Un circuito capacitivo puro genera \alert{señales en cuadratura} y \alert{adelanta la corriente}.
...
\begin{frame}[label={sec:orgaa7ee85}]{Resumen}
\[
  \begin{array}{lccc}
...
\]
\end{frame}
\begin{frame}[label={sec:org83db7d9}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org87f945b}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1ca2d97}]{Circuito RL (inductivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/RL.pdf}
\end{center}
...
\begin{frame}[label={sec:org32d877e}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org4a39948}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org592b323}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:org17960a3}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:orga56f616}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:org57c6446}]{Circuito RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orgab37e13}]{Circuito RLC paralelo}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/RLCparalelo.pdf}
\end{center}
...
\begin{frame}[label={sec:orga9ad437}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8fee2d6}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{../figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:org465a9b3}
\begin{frame}[label={sec:org799e499}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgc8f0da3}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgc3756c2}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:org35b6fae}]{Circuito Resistivo}
   \[
     P = UI\cos\theta \quad%
...
\begin{frame}[label={sec:org8c6c0c1}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org44fb89a}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:org4af0181}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:org2d5bdef}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\theta} \quad%
     Q = UI\sin\theta
   \]
...
\begin{frame}[label={sec:org54ab80e}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgb7a1c8d}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org34ca976}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org517826b}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge0db2a4}]{Potencia de elementos: Resistencia}
\[
\theta = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:org11d4be6}]{Potencia de elementos: Inductancia}
\[
\theta = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org237ea3a}]{Potencia de elementos: Condensador}
\[
\theta = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgf516a38}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:orgb08d4a8}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:orgda3c480}]{Medida de potencia}
\begin{center}
...
\label{sec:org6dd5d74}

\begin{frame}[label={sec:orgb305b40}]{Factor de potencia}
...
\begin{frame}[label={sec:org9b515f9}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc78e71e}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org52e35fd}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:org515dbbf}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:orgf58e81b}]{Cálculo de la Capacidad}
\begin{center}
...
\section{Teoremas}
\label{sec:org49876d0}
\begin{frame}[label={sec:org75eec72}]{Equivalencia de fuentes}
...
\begin{frame}[label={sec:org37e10eb}]{Teorema de superposición}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org208e47a}]{Teorema de superposición}
...
\begin{frame}[label={sec:org3bb9933}]{Teorema de superposición}
\framesubtitle{Análisis de un circuito mediante superposición}
...
\begin{frame}[label={sec:org76a2b19}]{Teorema de superposición}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgec8d55f}]{Teorema de superposición}
\framesubtitle{Potencia}
\begin{itemize}
...
\begin{frame}[label={sec:org5c7c001}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org95e290a}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgda1f4af}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org3c1ff7f}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:orgda52b66}]{Teoremas de Thévenin/Norton}
...
\begin{frame}[label={sec:org2a2ddbf}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgf862b22}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org3468492}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org153cb8b}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:org55ee44b}]{Máxima Transferencia de Potencia}
...
\begin{frame}[label={sec:orgd3671b6}]{Máxima Transferencia de Potencia}
