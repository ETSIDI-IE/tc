...
\label{sec:orgad54c59}

\begin{frame}[label={sec:orgc0cfe70}]{Forma de Onda}
\begin{itemize}
...
\begin{frame}[label={sec:org460316b}]{Clasificación}
...
\begin{frame}[label={sec:orgfb740ff}]{Clasificación}
...
\begin{frame}[label={sec:org0bdbab2}]{Valores que definen una onda periódica}
...
\begin{frame}[label={sec:orgf245eb8}]{Valores que definen una onda periódica}
\begin{itemize}
...
\begin{frame}[label={sec:org0cee74f}]{Valores que definen una onda periódica}
...
\begin{frame}[label={sec:org98d56f3}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:orga980a62}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:orgb4d7e63}]{Formas de Onda Periódicas}
\framesubtitle{Onda Triangular Bidireccional}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/triangular_periodica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org88254c4}]{Formas de Onda Periódicas}
...
\begin{frame}[label={sec:org904d3f8}]{Formas de Onda Periódicas}
...
\label{sec:org973b8e7}

\begin{frame}[label={sec:orgdf64a67}]{Definición}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/sin.pdf}
\end{center}
...
\begin{frame}[label={sec:org957a7ac}]{Fase}
\begin{center}
...
\begin{frame}[label={sec:orgc1774e0}]{Señales en Cuadratura}
\begin{center}
...
\begin{frame}[label={sec:org357c3bd}]{Valor medio y valor eficaz}
\begin{block}{Valor medio}
\[
...
\label{sec:org4a36737}

\begin{frame}[label={sec:orgb0649ca}]{Representación fasorial}
\begin{itemize}
...
\begin{frame}[label={sec:org4814dbb}]{Operaciones con fasores}
\begin{align*}
...
\begin{frame}[label={sec:org296630a}]{Tensión y corriente en notación fasorial}
\begin{center}
...
\begin{frame}[label={sec:orga73c5dc}]{Impedancia: relación entre fasores de tensión y corriente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org5087654}]{Impedancia Genérica}
\begin{columns}
...
\begin{frame}[label={sec:org442fff6}]{Circuito Resistivo}
...
\begin{frame}[label={sec:orgcc0ae36}]{Circuito Resistivo}
Un circuito resistivo no desfasa (\alert{tensión y corriente en fase}).
\begin{center}
...
\begin{frame}[label={sec:orgbd5801e}]{Circuito Inductivo puro}
...
\begin{frame}[label={sec:org5245bc1}]{Circuito Inductivo puro}
Un circuito inductivo puro genera \alert{señales en cuadratura} y \alert{retrasa la corriente}.
...
\begin{frame}[label={sec:org241eac2}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:org991aff8}]{Resumen}
\begin{columns}
\begin{column}{0.6\columnwidth}
\[
  \begin{array}{lccc}
...
\begin{frame}[label={sec:org8aabc70}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\begin{frame}[label={sec:org0e934cf}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org35895a2}]{Circuito RC (capacitivo con pérdidas)}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/RC.pdf}
\end{center}
...
\begin{frame}[label={sec:org7813cdf}]{Circuito RLC serie}
\begin{center}
...
\begin{frame}[label={sec:orgc01b035}]{Circuito RLC serie}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/RLC.pdf}
\end{center}
...
\begin{frame}[label={sec:orge32e18f}]{Circuito serie general}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org439fe00}]{Circuito paralelo general}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orgfd83058}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org530839b}]{Impedancia y Admitancia}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.1\textheight]{../figs/Z.pdf}
...
\end{frame}
\section{Potencia}
\label{sec:org7eed509}
\begin{frame}[label={sec:orgcd5d521}]{Expresión general}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgf84acac}]{Expresión general}
\begin{align*}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:orgcfbdef9}]{Expresión general}
\begin{equation*}
...
\begin{frame}[label={sec:org38cbef0}]{Circuito Resistivo}
   \[
...
\begin{frame}[label={sec:orgbebf5e6}]{Circuito Resistivo}
\begin{center}
...
\begin{frame}[label={sec:org625d555}]{Circuito Inductivo puro}
   \[
...
\begin{frame}[label={sec:org3d4081d}]{Circuito Inductivo puro}
\begin{center}
...
\begin{frame}[label={sec:orgb17d71a}]{Circuito Capacitivo puro}
   \[
     {\color{gray}P = UI\cos\varphi} \quad%
     Q = UI\sen\varphi
   \]
...
\begin{frame}[label={sec:org3c1deaa}]{Circuito Capacitivo puro}
\begin{center}
...
\begin{frame}[label={sec:orge296d64}]{Circuito Inductivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:orgf04e0f1}]{Circuito Capacitivo con pérdidas}
\begin{center}
...
\begin{frame}[label={sec:org70303a6}]{Triángulo de Potencias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org107841a}]{Potencia de elementos: Resistencia}
\[
\varphi = 0 \Rightarrow 
\begin{cases}
  P_R = R I^2\\
...
\begin{frame}[label={sec:orga6745a9}]{Potencia de elementos: Inductancia}
\[
\varphi = \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:org89d68fe}]{Potencia de elementos: Condensador}
\[
\varphi = - \pi/2 \Rightarrow 
\begin{cases}
  P_L = 0\\
...
\begin{frame}[label={sec:orgfe7b4e2}]{Teorema de Boucherot}
\begin{itemize}
...
\begin{frame}[label={sec:org22e9439}]{Medida de potencia}
\begin{center}
...
\begin{frame}[label={sec:org8dc2737}]{Medida de potencia}
\begin{center}
...
\label{sec:org0d554f2}

\begin{frame}[label={sec:org261969e}]{Factor de potencia}
...
\begin{frame}[label={sec:orgbc6f756}]{Potencia Aparente}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:org899726d}]{Sección de Conductores}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Fasores_CompensacionReactiva.pdf}
\end{center}
...
\begin{frame}[label={sec:orgdff20d2}]{Generación Local de Reactiva}
\begin{itemize}
...
\begin{frame}[label={sec:orgf3628e6}]{Compensación de Reactiva con Condensadores}
...
\begin{frame}[label={sec:org52c4fc9}]{Cálculo de la Capacidad}
\begin{center}
