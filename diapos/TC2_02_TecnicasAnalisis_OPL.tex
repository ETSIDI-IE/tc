...
\label{sec:org3fe690a}

\begin{frame}[label={sec:org568c8ac}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orgaa2f53a}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgb9133c0}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\label{sec:org03d7404}

\begin{frame}[label={sec:org8699f5d}]{Zona aislada}
...
\begin{frame}[label={sec:orgd637806}]{Zona aislada}
\begin{itemize}
...
\begin{frame}[label={sec:org777c0cd}]{Método de resolución (1)}
...
\begin{frame}[label={sec:org517c23a}]{Método de resolución (2)}
...
\begin{frame}[label={sec:org61afd8a}]{Método de resolución (3)}
...
\begin{frame}[label={sec:orgfdd5110}]{Método de resolución (y 4)}
...
\label{sec:orgd50843d}

\subsection{Método de las mallas}
\label{sec:org114f2a1}

\begin{frame}[label={sec:orgd631b4c}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge66dc8e}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org1ad53d2}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:orgc6998f4}]{Admitancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:orgb6b5549}]{Admitancia generalizada}
...
\begin{frame}[label={sec:orgbe588c3}]{Impedancia de Entrada}
...
\begin{frame}[label={sec:org7ec4be5}]{Impedancia de Transferencia}
...
\begin{frame}[label={sec:org4dc0fba}]{Mallas con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org90d97e2}]{Mallas con fuentes de intensidad ideales}
\begin{itemize}
...
\label{sec:org7859faa}
\begin{frame}[label={sec:orgfbf62ec}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudosAC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9654c40}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:orgf4a154d}]{Impedancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org9036ab1}]{Impedancia generalizada}
...
\begin{frame}[label={sec:org704ffd6}]{Admitancia de Entrada}
...
\begin{frame}[label={sec:orgeb63200}]{Admitancia de Transferencia}
...
\begin{frame}[label={sec:orgd70d114}]{Nudos con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org0b6f7df}]{Nudos con fuentes de tensión ideales}
\begin{itemize}
...
\begin{frame}[label={sec:org9f7efed}]{Nudos con fuentes de tensión ideales: supernudos}
