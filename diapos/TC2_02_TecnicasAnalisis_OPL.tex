...
\label{sec:org3aff95a}

\begin{frame}[label={sec:org986b06d}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org5c885e7}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orgbf9ffaf}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org1d1812b}]{Método de resolución (1)}
...
\begin{frame}[label={sec:orgf591dff}]{Método de resolución (3)}
...
\begin{frame}[label={sec:orgf289680}]{Método de resolución (y 4)}
...
\label{sec:org2283ad0}

\subsection{Método de las mallas}
\label{sec:org41bfbe2}

\begin{frame}[label={sec:orga5412e3}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org59959ec}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgca140f4}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:orgb0ecc7c}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
