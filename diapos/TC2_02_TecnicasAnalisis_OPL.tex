...
\label{sec:org8291b7c}

\begin{frame}[label={sec:orgc94a1ba}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org8c2e6fb}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org0ad90fe}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\label{sec:org169a985}

\begin{frame}[label={sec:orge882828}]{Zona aislada}
...
\begin{frame}[label={sec:org62aa038}]{Zona aislada}
\begin{itemize}
...
\begin{frame}[label={sec:org8a8d296}]{Método de resolución (1)}
...
\begin{frame}[label={sec:org50e62ef}]{Método de resolución (2)}
...
\begin{frame}[label={sec:org1d00734}]{Método de resolución (3)}
...
\begin{frame}[label={sec:orga076f17}]{Método de resolución (y 4)}
...
\label{sec:org881e747}

\subsection{Método de las mallas}
\label{sec:orga9a3930}

\begin{frame}[label={sec:org57c427c}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgeafa020}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgc1e6da2}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:org277d02b}]{Admitancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org9690fd8}]{Admitancia generalizada}
...
\begin{frame}[label={sec:org430baaa}]{Impedancia de Entrada}
...
\begin{frame}[label={sec:org3b14458}]{Impedancia de Transferencia}
...
\begin{frame}[label={sec:orgc604111}]{Mallas con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org00811ea}]{Mallas con fuentes de intensidad ideales}
\begin{itemize}
...
\label{sec:orgdc666e8}
\begin{frame}[label={sec:org2249d8d}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudosAC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9595d29}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org4178cde}]{Impedancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org793a1a7}]{Impedancia generalizada}
...
\begin{frame}[label={sec:org8b2b7ce}]{Admitancia de Entrada}
...
\begin{frame}[label={sec:orgc9ab830}]{Admitancia de Transferencia}
...
\begin{frame}[label={sec:org12efbfc}]{Nudos con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org924ea65}]{Nudos con fuentes de tensión ideales}
\begin{itemize}
...
\begin{frame}[label={sec:org11bf623}]{Nudos con fuentes de tensión ideales: supernudos}
