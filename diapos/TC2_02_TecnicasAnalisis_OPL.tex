...
\label{sec:orgb74ca83}

\begin{frame}[label={sec:orgf518a6b}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org990d7ec}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org7985986}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\label{sec:org1e7bd1d}

\begin{frame}[label={sec:org07982a1}]{Zona aislada}
...
\begin{frame}[label={sec:org2d6f363}]{Zona aislada}
\begin{itemize}
...
\begin{frame}[label={sec:org4a0d6f9}]{Método de resolución (1)}
...
\begin{frame}[label={sec:org3183858}]{Método de resolución (2)}
...
\begin{frame}[label={sec:orgd51c85f}]{Método de resolución (3)}
...
\begin{frame}[label={sec:org0b6b6ae}]{Método de resolución (y 4)}
...
\label{sec:org455a6f9}

\subsection{Método de las mallas}
\label{sec:org5316aa8}

\begin{frame}[label={sec:orgea44662}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6d19315}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgfedfbee}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:org3bd95a1}]{Impedancia de Entrada}
...
\begin{frame}[label={sec:org3edd4cc}]{Impedancia de Transferencia}
...
\begin{frame}[label={sec:org8bb9b91}]{Mallas con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org5cca00e}]{Mallas con fuentes de intensidad ideales}
\begin{itemize}
...
\label{sec:orgbe9c45b}
\begin{frame}[label={sec:org2b2da38}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudosAC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org89e70b0}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org9ba7bcf}]{Admitancia de Transferencia}
...
\begin{frame}[label={sec:org39b0ed9}]{Nudos con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org427f4c4}]{Nudos con fuentes de tensión ideales}
\begin{itemize}
