...
\label{sec:org6a211a8}

\begin{frame}[label={sec:org726a607}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:orgdfcfe8a}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:org9dabe04}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\label{sec:org54d7d7e}

\subsection{Método de las mallas}
\label{sec:org104853d}

\begin{frame}[label={sec:orgaa64699}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5786719}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org5db926f}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:org6c7fcd2}]{Admitancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org068ede4}]{Admitancia generalizada}
...
\begin{frame}[label={sec:org49c45b8}]{Impedancia de Entrada}
...
\begin{frame}[label={sec:org6c95628}]{Impedancia de Transferencia}
...
\begin{frame}[label={sec:orgc896abe}]{Mallas con fuentes de intensidad ideales}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org97d192a}]{Mallas con fuentes dependientes}
\begin{itemize}
...
\label{sec:orgb3e2a2c}
\begin{frame}[label={sec:org3bf8f5a}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudosAC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc25ac8f}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org19538c2}]{Impedancia generalizada}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:org2db759e}]{Impedancia generalizada}
...
\begin{frame}[label={sec:orgf22f73a}]{Admitancia de Entrada}
...
\begin{frame}[label={sec:org8a312ba}]{Admitancia de Transferencia}
...
\begin{frame}[label={sec:orgb12292a}]{Nudos con fuentes de tensión ideales}
\begin{itemize}
...
\begin{frame}[label={sec:orgd7deb94}]{Nudos con fuentes de tensión ideales: supernudos}
...
\begin{frame}[label={sec:org7c6ca2b}]{Nudos con fuentes dependientes}
\begin{itemize}
