...
\label{sec:org72fa2ee}

\begin{frame}[label={sec:org3c1bc1e}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org0b7be33}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orga761936}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\begin{frame}[label={sec:org5804591}]{Método de resolución (1)}
...
\begin{frame}[label={sec:org1240061}]{Método de resolución (3)}
...
\begin{frame}[label={sec:org880eec7}]{Método de resolución (y 4)}
...
\label{sec:orgdf9e449}

\subsection{Método de las mallas}
\label{sec:org55425c7}

\begin{frame}[label={sec:orgea82c1e}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/mallas1_corrientes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org38d0cc6}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgd7eead2}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:org5aa19a4}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
