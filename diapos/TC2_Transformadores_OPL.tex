...
\begin{frame}[label={sec:org0ef0085}]{Recordatorio}
\begin{columns}
...
\label{sec:orgf452604}

\begin{frame}[label={sec:orgcd79e08}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:org5ed13a3}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orge5cad87}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:org01ae704}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\label{sec:orgc2f171c}
\begin{frame}[label={sec:org28fd918}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgd1ae28c}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org0003fb9}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4b8da8f}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:orga90c7c5}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgbcefa30}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:org8d82843}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb48a231}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3e22c9b}]{Tensión de Thévenin}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdc97ec3}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org62462de}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge59f227}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\label{sec:org34fb9ec}
\begin{frame}[label={sec:org4625ccb}]{Definición}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org024b582}]{El flujo en cada bobina es nulo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org233b397}]{El flujo mutuo es nulo}
...
\]
\end{frame}
\begin{frame}[label={sec:orgbc93898}]{Relación de Transformación}
Hemos obtenido:
\[
...
\]
\end{frame}
\begin{frame}[label={sec:org00c5da6}]{Un transformador ideal no consume potencia}
\[
...
\label{sec:org45ab9c9}
\begin{frame}[label={sec:org8d63bb3}]{Fuente de Tensión de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgecf4893}]{Fuente de Tensión de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org2b98aae}]{Fuente de Corriente de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgd2ed657}]{Fuente de Corriente de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgde915be}]{Impedancia de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgcfb9175}]{Impedancia de Primario a Secundario}
\begin{center}
...
\label{sec:org1b63a2d}
\begin{frame}[label={sec:org193763a}]{Recordatorio: impedancia de entrada de un T. Perfecto}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org75b4417}]{Circuito equivalente con transformador ideal}
\begin{columns}
...
\begin{frame}[label={sec:org3ec8e1e}]{Recordatorio: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\begin{frame}[label={sec:orgac13de6}]{Equivalente en primario con transformador ideal}
\[
  \overline{Z}_{th} = \frac{1}{a^2} \cdot \frac{j \omega L_1 \cdot \overline{Z}_g}{j\omega L_1 + \overline{Z}_g}
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org156c2a3}]{Equivalente en secundario con transformador ideal}
\[
...
\label{sec:org215f07a}
\begin{frame}[label={sec:orgefbe2c3}]{Transformador Real de Varios Devanados}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3edc356}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:org44eda4a}]{Transformador Perfecto}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2e1ceca}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:org98f4efd}]{Relaciones de Transformación}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org12ed323}]{Transformador Ideal}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoIdealVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbfad91f}]{Relación de Transformación del Transformador Ideal}
\begin{center}
...
\begin{frame}[label={sec:org7ae2ac9}]{Impedancia de Entrada}
\begin{center}
...
\begin{frame}[label={sec:org6d8291f}]{Impedancia de Entrada}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org42cc4aa}]{Circuito Equivalente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrafoIdealVariosDevanados_Impedancia.pdf}
...
\begin{frame}[label={sec:orgf5c0ae4}]{Circuito Equivalente de un Transformador Perfecto}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7d358cf}]{Circuito Equivalente de un Transformador Perfecto}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/TrafoPerfectoIdealVariosDevanados_Impedancia.pdf}
...
\label{sec:org73d7a84}
\begin{frame}[label={sec:org641a1d3}]{Autotransformador Perfecto}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/AutotrafoPerfecto.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgee2c02c}]{Ecuaciones del Autotransformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org8ba0d0e}]{Circuito Alternativo del Autotransformador Perfecto}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/AutotrafoPerfecto2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf7aa12d}]{Ecuaciones del Circuito Alternativo}
\begin{center}
...
\begin{frame}[label={sec:org2156d47}]{Ecuaciones Comparadas}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7cfa4c7}]{Transformador Perfecto Equivalente}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org8c8cb32}]{Transformador Perfecto Equivalente}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org33c90aa}]{Autotransformador Ideal}
\begin{columns}
