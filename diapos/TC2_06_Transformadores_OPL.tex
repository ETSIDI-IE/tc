...
\begin{frame}[label={sec:org671f347}]{Recordatorio}
\begin{columns}
...
\label{sec:org316073a}

\begin{frame}[label={sec:org49b2f2e}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orgcec633c}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb94bc86}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:orgdee3fe6}]{Ejemplo: impedancia de entrada desde primario}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/Trafo_Real_ImpSec.pdf}
\end{center}
...
\begin{frame}[label={sec:org053ee54}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Real_FuentePrimario.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org091ba82}]{Tensión de Thévenin}
\begin{columns}
...
\begin{frame}[label={sec:orgc0c9341}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Real_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgef2251e}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Real_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org495de4d}]{Impedancia de Thévenin}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1c7f446}]{Resumen: Equivalente de Thévenin}
\begin{center}
...
\label{sec:org0a38778}
\begin{frame}[label={sec:org0ffc58a}]{Definición}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org56bbe57}]{Relación de Transformación}
...
\]
\end{frame}
\begin{frame}[label={sec:org887e327}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org75c4f7c}]{Relación de Tensiones}
...
\]
\end{frame}
\begin{frame}[label={sec:org7696668}]{Ejemplo: Impedancia de Entrada}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgd89ed83}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
Despejamos \(I_2\):
...
\]
\end{frame}
\begin{frame}[label={sec:orgbcbcadc}]{Ejemplo: Impedancia de Entrada}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf6feaac}]{Ejemplo: Equivalente de Thévenin desde secundario}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6a1b54a}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2e4a8ea}]{Tensión de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3738130}]{Impedancia de Thévenin}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7855488}]{Impedancia de Thévenin}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Trafo_Perfecto_ImpedanciaPrimario.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org719a965}]{Resumen: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\label{sec:orgcf062f1}
\begin{frame}[label={sec:orgb4685ac}]{Definición}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org36ab25e}]{El flujo en cada bobina es nulo}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orge89294f}]{El flujo mutuo es nulo}
...
\]
\end{frame}
\begin{frame}[label={sec:org268821c}]{Relación de Transformación}
Hemos obtenido:
\[
...
\]
\end{frame}
\begin{frame}[label={sec:org9c1727d}]{Un transformador ideal no consume potencia}
\[
...
\label{sec:org31082cc}
\begin{frame}[label={sec:orgcebeb8e}]{Fuente de Tensión de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb27dd97}]{Fuente de Tensión de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org30e4071}]{Fuente de Corriente de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgace3d53}]{Fuente de Corriente de Primario a Secundario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org353fd9c}]{Impedancia de Secundario a Primario}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org8c9efde}]{Impedancia de Primario a Secundario}
\begin{center}
...
\label{sec:org26e177e}
\begin{frame}[label={sec:org2a01bb6}]{Recordatorio: impedancia de entrada de un T. Perfecto}
\begin{center}
\includegraphics[height=0.45\textheight]{../figs/TrafoPerfecto_ImpedanciaSecundario.pdf}
\end{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgc6c3c63}]{Circuito equivalente con transformador ideal}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org08e8444}]{Recordatorio: Equivalente de Thévenin}
\begin{center}
\includegraphics[height=0.5\textheight]{../figs/Trafo_Perfecto_FuentePrimario.pdf}
\end{center}
...
\begin{frame}[label={sec:orgcff2c06}]{Equivalente en primario con transformador ideal}
\[
  \overline{Z}_{th} = \frac{1}{a^2} \cdot \frac{j \omega L_1 \cdot \overline{Z}_g}{j\omega L_1 + \overline{Z}_g}
\]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6dbb792}]{Equivalente en secundario con transformador ideal}
\[
...
\label{sec:org078232d}
\begin{frame}[label={sec:org96a25df}]{Transformador Real de Varios Devanados}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4e690d7}]{Ecuaciones del Transformador Real}
\begin{center}
...
\begin{frame}[label={sec:orgc8537cc}]{Transformador Perfecto}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org43ccc58}]{Ecuaciones del Transformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:orgcb20ad8}]{Relaciones de Transformación}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7256f8f}]{Transformador Ideal}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrafoIdealVariosDevanados.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5c299fe}]{Relación de Transformación del Transformador Ideal}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org7936d55}]{Impedancia de Entrada}
\begin{center}
...
\begin{frame}[label={sec:org18dcd90}]{Impedancia de Entrada\footnote{Las corrientes en 2 y 3 son salientes, y por tanto, en la ecuación de corrientes usamos el signo positivo.}}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0db9cca}]{Circuito Equivalente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrafoIdealVariosDevanados_Impedancia.pdf}
...
\begin{frame}[label={sec:org5472ee8}]{Circuito Equivalente de un Transformador Perfecto}
\vspace{0.3cm}
\begin{columns}
...
\begin{frame}[label={sec:orgc759203}]{Circuito Equivalente de un Transformador Perfecto}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/TrafoPerfectoIdealVariosDevanados_Impedancia.pdf}
...
\label{sec:org7b3eabd}
\begin{frame}[label={sec:org790a5bc}]{Autotransformador Perfecto}
\begin{center}
...
\begin{frame}[label={sec:org296d358}]{Ecuaciones del Autotransformador Perfecto}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org362d644}]{Circuito Alternativo del Autotransformador Perfecto}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/AutotrafoPerfecto2.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge0b5cbf}]{Ecuaciones del Circuito Alternativo}
\begin{center}
...
\begin{frame}[label={sec:orgccafa2b}]{Ecuaciones Comparadas}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org91cc7a4}]{Transformador Perfecto Equivalente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.6\textheight]{../figs/AutotrafoPerfecto.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org869e9ba}]{Transformador Perfecto Equivalente}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[height=0.6\textheight]{../figs/AutotrafoPerfecto.pdf}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org099567f}]{Equivalente del Autotransformador Ideal}
\begin{columns}
