...
\label{sec:orgef823ec}

\subsection{¿Qué es el régimen transitorio?}
\label{sec:org0e78812}
\begin{frame}[label={sec:orge894b05}]{Permanente y Transitorio}
...
\begin{frame}[label={sec:orga5a05b9}]{Acumulación de Energía}
...
\label{sec:org8e6854d}
\begin{frame}[label={sec:org323d7ff}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8a430ad}]{Respuesta natural y forzada}
\begin{itemize}
...
\begin{frame}[label={sec:org744bd8b}]{Respuesta completa (ejemplo)}
\begin{align*}
  i(t) &= i_n(t) + i_\infty(t)\\
  i_n(t) &= A e^{st}\\
  i_\infty(t) &= U_0/R\\
...
\begin{frame}[label={sec:org3a2216e}]{Respuesta completa}
\[
  \boxed{i(t) = \frac{U_0}{R}(1 - e^{-\frac{t}{\tau}})  }
\]
...
\begin{frame}[label={sec:orgb445dda}]{Expresión general de la respuesta completa}
\[
...
\begin{frame}[label={sec:orgbfca109}]{Respuesta natural}
\begin{center}
...
\begin{frame}[label={sec:org1aa0d8c}]{Constante de tiempo}
\begin{itemize}
...
\begin{frame}[label={sec:orga62c9b7}]{Balance Energético}
...
\begin{frame}[label={sec:org512fc60}]{Expresión general de la respuesta completa}
\[
...
\begin{frame}[label={sec:org4dd8940}]{Ejemplo con respuesta forzada}
\begin{center}
...
\begin{frame}[label={sec:orga2bd7e2}]{Equivalente de Norton}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/Thevenin_PrimerOrden.pdf}
\end{center}
\end{frame}
...
\label{sec:org3073300}

\begin{frame}[label={sec:org40721f7}]{Equivalente de Thévenin/Norton}
\begin{center}
\includegraphics[height=0.85\textheight]{figs/Thevenin_PrimerOrden.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga73b058}]{Procedimiento General}
\begin{itemize}
...
\label{sec:org4041df7}
\begin{frame}[label={sec:orgf57af27}]{Introducción}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc7f59d1}]{Respuesta natural y forzada}
\begin{itemize}
...
\label{sec:orgd6037b6}
\begin{frame}[label={sec:orgc95daad}]{Circuito básico}
\begin{center}
...
\begin{frame}[label={sec:orge2c8ce6}]{Respuesta natural (t > 0)}
\begin{center}
...
\begin{frame}[label={sec:org05725b1}]{Solución}
...
\begin{frame}[label={sec:org8580fa9}]{Parámetros}
\begin{columns}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1201fff}]{Posibles soluciones}
\[
...
\begin{frame}[label={sec:orgc08bc70}]{Tipos de Respuesta}
\begin{itemize}
...
\begin{frame}[label={sec:orgda29c9e}]{Circuito Sobreamortiguado (\(\alpha > \omega_0\))}
\[
...
\begin{frame}[label={sec:orgd134013}]{Amortiguamiento Crítico (\(\alpha = \omega_0\))}
\[
...
\begin{frame}[label={sec:org20e83f7}]{Circuito Subamortiguado (\(\alpha < \omega\))}
\[
...
\begin{frame}[label={sec:org5d77fae}]{Valores Importantes}
\begin{center}
\includegraphics[height=0.6\textheight]{figs/RespuestaEscalon_SegundoOrden.png}
\end{center}
...
\begin{frame}[label={sec:orgb74ca4f}]{Condiciones Iniciales}
...
\begin{frame}[label={sec:org9773acf}]{Derivadas en \(t = 0^+\)}
\begin{center}
...
\begin{frame}[label={sec:orga63e5ca}]{Respuesta Completa}
...
\begin{frame}[label={sec:org5b49da5}]{Ejemplo de Respuesta Completa}
...
\label{sec:org37ee37e}
\begin{frame}[label={sec:orgd63ffa2}]{Circuito básico}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/transitorio_circuitoRLC_paralelo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga3dcad0}]{Respuesta natural (t > 0)}
\begin{center}
...
\begin{frame}[label={sec:org2ed8a59}]{Solución}
\begin{block}{Ecuación diferencial}
\[
  \diff[2]{u}{t} + \frac{G}{C} \diff{u}{t} + \frac{1}{LC} u = 0
\]
...
\begin{frame}[label={sec:org46dbc47}]{Parámetros}
\begin{block}{Ecuación característica}
\begin{columns}
\begin{column}{.5\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:org0faf772}]{Tipos de Respuesta}
\begin{itemize}
...
\begin{frame}[label={sec:org015c9cb}]{Tipos de Respuesta}
\begin{itemize}
...
\begin{frame}[label={sec:org866c6aa}]{Condiciones Iniciales}
\begin{block}{Dos constantes a determinar}
Son necesarias dos tipos de condiciones iniciales:
...
\begin{frame}[label={sec:org434750b}]{Derivadas en \(t = 0^+\): ejemplo RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orgaad590e}]{Respuesta Completa}
Las condiciones iniciales deben evaluarse teniendo en cuenta la respuesta forzada (si existe).
\begin{align*}
...
\begin{frame}[label={sec:org1915a04}]{Ejemplo de Respuesta Completa}
