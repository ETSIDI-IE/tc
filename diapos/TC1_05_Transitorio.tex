...
\begin{frame}[label={sec:org1fc459d}]{Respuesta completa (ejemplo)}
\begin{align*}
  i(t) &= i_n(t) + i_\infty(t)\\
  i_n(t) &= A e^{st}\\
  i_\infty(t) &= U_0/R\\
...
\begin{frame}[label={sec:org73908df}]{Respuesta completa}
\[
  \boxed{i(t) = \frac{U_0}{R}(1 - e^{-\frac{t}{\tau}})  }
\]
...
\begin{frame}[label={sec:org08f7064}]{Expresión general de la respuesta completa}
\[
...
\begin{frame}[label={sec:orgfb47f33}]{Respuesta natural}
\begin{center}
...
\begin{frame}[label={sec:org6e24f6d}]{Constante de tiempo}
\begin{itemize}
...
\begin{frame}[label={sec:org2fd3e81}]{Balance Energético}
...
\begin{frame}[label={sec:org29b23a5}]{Expresión general de la respuesta completa}
\[
...
\begin{frame}[label={sec:org49abd4a}]{Ejemplo con respuesta forzada}
\begin{center}
...
\begin{frame}[label={sec:orga2ef1ac}]{Equivalente de Norton}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Thevenin_PrimerOrden.pdf}
\end{center}
\end{frame}
...
\label{sec:org0fc676f}

\begin{frame}[label={sec:orgcd39d77}]{Equivalente de Thévenin/Norton}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/Thevenin_PrimerOrden.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0977292}]{Procedimiento General}
\begin{itemize}
...
\label{sec:org16f4a16}
\begin{frame}[label={sec:orge056e38}]{Introducción}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org245378a}]{Respuesta natural y forzada}
\begin{itemize}
\item El método de resolución analiza el circuito en dos etapas:
\begin{itemize}
...
\label{sec:org05ab4c3}
\begin{frame}[label={sec:org15be7b2}]{Circuito básico}
\begin{center}
...
\begin{frame}[label={sec:org5991009}]{Respuesta natural (t > 0)}
\begin{center}
...
\begin{frame}[label={sec:orgc81cd0c}]{Solución}
...
\begin{frame}[label={sec:orgd437aec}]{Parámetros}
\begin{columns}
...
\begin{frame}[label={sec:org9a8214a}]{Circuito Sobreamortiguado (\(\alpha > \omega_0\))}
\[
...
\begin{frame}[label={sec:org9c76070}]{Amortiguamiento Crítico (\(\alpha = \omega_0\))}
\[
...
\begin{frame}[label={sec:orgfbf5bc5}]{Valores Importantes}
\begin{center}
\includegraphics[height=0.6\textheight]{figs/RespuestaEscalon_SegundoOrden.png}
\end{center}
...
\begin{frame}[label={sec:orgcf1d0d6}]{Condiciones Iniciales}
...
\begin{frame}[label={sec:orge73d0ba}]{Derivadas en \(t = 0^+\)}
\begin{center}
...
\begin{frame}[label={sec:org864b170}]{Respuesta Completa}
...
\begin{frame}[label={sec:org3bc8aab}]{Ejemplo de Respuesta Completa}
...
\label{sec:org5cd26d5}
\begin{frame}[label={sec:org09f6947}]{Circuito básico}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/transitorio_circuitoRLC_paralelo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4918be0}]{Respuesta natural (t > 0)}
\begin{center}
...
\begin{frame}[label={sec:orgdf86943}]{Solución}
\begin{block}{Ecuación diferencial}
\[
  \diff[2]{u}{t} + \frac{G}{C} \diff{u}{t} + \frac{1}{LC} u = 0
\]
...
\begin{frame}[label={sec:org33c3d6c}]{Tipos de Respuesta}
\begin{itemize}
...
\begin{frame}[label={sec:org0913669}]{Condiciones Iniciales}
\begin{block}{Dos constantes a determinar}
Son necesarias dos tipos de condiciones iniciales:
...
\begin{frame}[label={sec:orgdb5413a}]{Derivadas en \(t = 0^+\): ejemplo RLC paralelo}
\begin{center}
...
\begin{frame}[label={sec:orge09cb6b}]{Respuesta Completa}
Las condiciones iniciales deben evaluarse teniendo en cuenta la respuesta forzada (si existe).
\begin{align*}
...
\begin{frame}[label={sec:orga67df28}]{Ejemplo de Respuesta Completa}
