...
\label{sec:org1f093c6}

\begin{frame}[label={sec:org174c388},plain]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org21abc32}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:org97e40e5}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:orgb194efc}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org08abc1b}
\begin{frame}[label={sec:orgf6f8f4a}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org54dc2c6}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org23d003b}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org6b22916}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org445ffc7}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org99f95b7}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org1482c38}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgf710126}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org2c889f5}
\begin{frame}[label={sec:org7389ac9}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org12e941d}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2d03f5f}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga0e666e}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb69c09d}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6a4fe6b}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2e9bb45}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org6b19cae}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc0eb672}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org63d637f}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org6056169}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgaf8292f}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org33270c2}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org98b53a5}

\begin{frame}[label={sec:orgec96191}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:org16a6638}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org9a32857}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgbf453ad}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgd694637}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgcba97dc}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org22ad18d}]{Comparativa Monofásica-Trifásica}
...
\label{sec:orgcebdae7}

\begin{frame}[label={sec:orgb9e6134}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org402a3ce}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org05548ea}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org300bfc6}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgc411853}
\begin{frame}[label={sec:orgebe1c36}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org7794189}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org5fe3b00}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2a3ad95}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdb62b9e}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org05b333b}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org739bc53}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org0496b73}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org6c7568d}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgb88116f}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org36da3ad},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:orgd63b3e0},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org0ba385b}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:orgfd3474b}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgaba434c}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
