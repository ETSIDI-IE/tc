...
\label{sec:orga725f22}

\begin{frame}[label={sec:orgb9710df},plain]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org92b3b8c}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfd40b00}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:org426f9fa}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:orgb81dcb9}
\begin{frame}[label={sec:orgafa850d}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org9728506}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:orgd7ee884}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org54349f4}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orge0e3dee}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org95e3824}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org3f5b93b}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org744c85c}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orga5fdbb1}
\begin{frame}[label={sec:orgf2dfd84}]{Tipos de Receptores}
...
\begin{frame}[label={sec:orgdedaf52}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org82d00c0}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0fe1c38}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgfaeca33}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org505044e}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3baf184}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgd32e366}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org03cc6b0}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7623d65}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgf54f495}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd336d07}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3a00017}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org3a2d363}

\begin{frame}[label={sec:org43a87ff}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:org2421873}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org29ea575}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org7506f93}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org0720621}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org809f75f}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orge79d75f}]{Comparativa Monofásica-Trifásica}
...
\label{sec:org10123ea}

\begin{frame}[label={sec:org8383b66}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org84d1154}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5a925e7}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb504817}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgfece948}
\begin{frame}[label={sec:org44783e6}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org2c26902}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org686eda5}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8799f3c}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6915727}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:orgbf44fef}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgf106a15}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org0261646}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org55e86a8}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orga04ffbb}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcc95760},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org567895a},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org6b3acac}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org6712274}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd0d3679}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
