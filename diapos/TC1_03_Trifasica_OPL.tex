...
\label{sec:org68a8204}

\begin{frame}[label={sec:org5217d18},plain]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgcb0a0c6}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:org11b06fe}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:org9e01f94}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:orgbcb165f}
\begin{frame}[label={sec:orgcaacc41}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:orgc0f9db1}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org6ba111f}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org2729238}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgeb590c2}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5d81adb}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orgd163a6c}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgb71ae5b}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org1c79be6}
\begin{frame}[label={sec:org98bbcd5}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org3a293bf}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8a83aff}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2ea899f}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2c4ddc7}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4a8b096}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbcc9a63}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgc5ca512}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge3aaa35}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge174984}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org361674e}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2b351fe}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5e80efc}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org8dfae37}

\begin{frame}[label={sec:org8336fc9}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:org85fdac5}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org41f12c6}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgdc28e76}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org9a38970}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org256ebc5}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org16ce2d2}]{Comparativa Monofásica-Trifásica}
...
\label{sec:org83f7bf0}

\begin{frame}[label={sec:orgba84670}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org23b1d27}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgeda3f0d}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3050c97}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgd630ec3}
\begin{frame}[label={sec:orgdf44c32}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org8d5ccdf}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org513d592}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9ee357c}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3880f98}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:orgb75d496}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org91ddf0b}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:orgbfcf92a}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orgaf19297}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org8207700}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0d64bdd},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org565f33a},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org78a5d15}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org67a820a}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7b1fd94}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
