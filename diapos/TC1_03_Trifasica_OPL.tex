...
\label{sec:org3275944}

\begin{frame}[label={sec:org5d53512},plain]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0a000bd}]{Motivación de los sistemas trifásicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgec39fd3}]{Ondas Trifásicas}
\begin{center}
...
\begin{frame}[label={sec:orgd9cfd49}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org2eb9c95}
\begin{frame}[label={sec:orgaf3de9f}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:orgcad37dc}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org3ae8865}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org734fd0e}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org3e5125c}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgafa9aa3}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org5375b41}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org3eab60a}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orgf5db4a3}
\begin{frame}[label={sec:org97ba338}]{Tipos de Receptores}
...
\label{sec:orgdbf0240}

\begin{frame}[label={sec:org6771491}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3b761ec}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org34d7fdc}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org408c56e}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org38dbd69}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org372c437}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\label{sec:org1b5a10d}

\begin{frame}[label={sec:org2b66659}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc39e2ff}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdbd49d3}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org128aa52}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org348a4fd}]{Receptor en Triángulo Desequilibrado}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/TrianguloDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org291346c}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org6d811bb}


\subsection{Cálculo de potencia}
\label{sec:org016bd99}
\begin{frame}[label={sec:orgf0a6290}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgb58bc09}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org6455d29}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org160e94b}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:org306ad1a}
\begin{frame}[label={sec:org950bd88}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org87f6ce8}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org9101603}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1df2fa4}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgca95b37}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org2ce4eee}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org25f35f5}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org948ae3e}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org5ed1441}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:orge7c7fb2}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf59391c},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org0a7b897},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org352b84e}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org1773bc7}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0643d34}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:orgf13e621}

\begin{frame}[label={sec:org2296202}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org51614a5}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgcbe2c15}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0a0af9a}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgc3babd6}

\begin{frame}[label={sec:org4580c57}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:org35f848a}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:orga4aec1b}]{Masa de conductor}
