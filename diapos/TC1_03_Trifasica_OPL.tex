...
\begin{frame}[label={sec:org2be8bf7}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:org56a086d}
\begin{frame}[label={sec:org23ead72}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:orgebd37af}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org0871a81}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org5bcb51d}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgaa9015b}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7cbde7c}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org950e7ff}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgd8983e1}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\begin{frame}[label={sec:org366dc61}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2945963}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgafea274}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org48aebf3}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org7ff007f}

\begin{frame}[label={sec:org60aaae0}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:orgfb30652}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:org70c56a9}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgb388788}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgab66c14}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org9dfe7a4}]{Comparativa Monofásica-Trifásica}
...
\label{sec:orgd6c5059}

\begin{frame}[label={sec:orgab27b62}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:orgc2e629f}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org29b6583}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org075337b}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org647039a}
\begin{frame}[label={sec:org7afa086}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org7ff0903}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgf2803c0}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org08d3219}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgda944df}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:org2044001}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org19b3508}]{Sistema de 3 Hilos Equilibrado}
Supongamos SFD:
...
\begin{frame}[label={sec:org7437ea1}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org79e63a1}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org0c78110}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org038f779},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org351209e},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org38f31e8}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org05f4f56}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org090aa24}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
