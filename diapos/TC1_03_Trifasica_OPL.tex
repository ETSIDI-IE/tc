...
\begin{frame}[label={sec:orgff56894}]{Fasores de un sistema trifásico}
\begin{center}
...
\section{Generadores}
\label{sec:orgc0a3b38}
\begin{frame}[label={sec:orge933f87}]{Conexión}
\begin{center}
...
\begin{frame}[label={sec:org3372aa4}]{Las tensiones suman 0}
\begin{center}
...
\begin{frame}[label={sec:org4c00c38}]{Las tensiones suman 0}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TensionesTrifasica.pdf}
\end{center}
...
\begin{frame}[label={sec:org6da56e1}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:orgfa836fd}]{Tensiones de Fase y Línea}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{align*}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgabbabcf}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org4d8d4f3}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org3be6a40}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:orgc86b0fd}
\begin{frame}[label={sec:orgf9f3010}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org0ff94c2}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado.pdf}
\end{center}
\end{frame}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org242bf44}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org74b8bab}]{Receptor en Triángulo Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org516fc4d}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga10cec9}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgca6cb84}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7464b48}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6e44130}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:org8abb053}

\begin{frame}[label={sec:org0c7d5b9}]{Potencia Instantánea en Sistemas Equilibrados}
...
\begin{frame}[label={sec:org193bbcc}]{Potencia Instantánea en Sistemas Equilibrados}
\begin{align*}
...
\begin{frame}[label={sec:orgc72df1e}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgcc37ca3}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org8f0399e}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org947f11a}]{Comparativa Monofásica-Trifásica}
...
\label{sec:orgd804107}

\begin{frame}[label={sec:orgb7dfde3}]{Objetivo}
\begin{itemize}
...
\begin{frame}[label={sec:org4334115}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org31c5305}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc6c9192}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgd9c9cab}
\begin{frame}[label={sec:org7d56d88}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orga6ebc9a}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgbe2a767}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7ee3739}]{Sistema de 3 Hilos}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3bf117d}]{Sistema de 3 Hilos}
...
\begin{frame}[label={sec:orge481af2}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org0e073f7}]{Sistema de 3 Hilos Equilibrado}
...
\begin{frame}[label={sec:org4b094d3},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:orgc4491db}]{Medida de Reactiva con un Vatímetro}
...
\begin{frame}[label={sec:org0307a3d}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org820cf7b}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
