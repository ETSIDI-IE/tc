...
\label{sec:orgb0aeb65}

\begin{frame}[label={sec:orgfc00921}]{Nudo, rama, malla}
\begin{description}
...
\begin{frame}[label={sec:org07dc7eb}]{Ley de Kirchhoff de las Corrientes (LKC)}
\begin{itemize}
...
\begin{frame}[label={sec:orge00bcf3}]{Ley de Kirchhoff de los Voltajes (LKV)}
\begin{itemize}
...
\label{sec:orgca88cf6}

\begin{frame}[label={sec:orgaeeab57}]{Zona aislada}
...
\begin{frame}[label={sec:org060864c}]{Zona aislada}
\begin{itemize}
...
\begin{frame}[label={sec:org2b2f363}]{Método de resolución (1)}
...
\begin{frame}[label={sec:org6658ae7}]{Método de resolución (2)}
...
\begin{frame}[label={sec:org223c553}]{Método de resolución (3)}
...
\begin{frame}[label={sec:org460f797}]{Método de resolución (y 4)}
...
\begin{frame}[label={sec:org2dc5fcd}]{Ecuación General}
\begin{equation*}
  \begin{bmatrix}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgb1e0acd}]{Procedimiento}
\begin{enumerate}
...
\begin{frame}[label={sec:org4865a04}]{Impedancia de Entrada}
...
\begin{frame}[label={sec:org40927ec}]{Impedancia de Transferencia}
...
\begin{frame}[label={sec:org7c177a7}]{Mallas con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org74cb98d}]{Mallas con fuentes de intensidad ideales}
\begin{itemize}
...
\label{sec:org97bb8a1}
\begin{frame}[label={sec:org3e4bc4b}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/nudosAC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5e8c2af}]{Ecuación general}
\begin{equation*}
  \begin{bmatrix}
...
\begin{frame}[label={sec:orga47bba7}]{Admitancia de Transferencia}
...
\begin{frame}[label={sec:org0e54f85}]{Nudos con fuentes dependientes}
\begin{itemize}
...
\begin{frame}[label={sec:org0989c80}]{Nudos con fuentes de tensión ideales}
\begin{itemize}
