...
\section{Generadores}
\label{sec:org3295b44}
\begin{frame}[label={sec:org8938c28}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org6c79154}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgccdaf03}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orge03896d}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgd32ec8d}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org45ece05}
\begin{frame}[label={sec:orgc1d1ad4}]{Tipos de Receptores}
...
\begin{frame}[label={sec:orgfcfdeb9}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3416f24}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbe65b5e}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge5237f7}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org00705a8}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org99b3326}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1d8362e}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:orgfd70cab}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org8664d8e}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org959e703}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgddc3f10}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgb1bc6a2}]{Transformación de receptores}
...
\begin{frame}[label={sec:org18ce548}]{Transformación de receptores}
...
\label{sec:org59a068b}

\begin{frame}[label={sec:orgff99688}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgdfb6f87}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org1dde064}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org8b39f59}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:orga735c60}

\begin{frame}[label={sec:org0f1c1ff}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org301feef}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf9ef28e}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org1f33de5}
\begin{frame}[label={sec:orgafbeb80}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org8d9b2fb}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org12b18d8}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4b81386},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:orgc219cc0},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:org2285228}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge49835d}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org84111b4}]{Medida de la reactiva con receptor desequilibrado}
\begin{center}
...
\label{sec:org835c845}

\begin{frame}[label={sec:orgf143d14}]{Estrella a Triángulo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealEstrella.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org019a412}]{Transformamos impedancia}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1ec08af}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_ZTriangulo.pdf}
...
\begin{frame}[label={sec:org60b04ff}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_Transformado1.pdf}
...
\begin{frame}[label={sec:orgbc07bca}]{Triángulo a Estrella}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealTriangulo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0657e01}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5d1ec0f}]{Transformamos impedancias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I.pdf}
...
\begin{frame}[label={sec:orgd4bcc30}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I_ZEstrella.pdf}
...
\begin{frame}[label={sec:orgd2bbc02}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado1.pdf}
...
\begin{frame}[label={sec:org9e22163}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado2.pdf}
...
\label{sec:orgda1280e}
\begin{frame}[label={sec:org549fbd5}]{Planteamiento del sistema}
\begin{center}
...
\begin{frame}[label={sec:orgcb25339}]{Agrupamos impedancias de generador, línea y receptor}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org6db7a3d}]{Conversión de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org681918b}]{Tensión de desplazamiento del neutro}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CircuitoTrifasicaGeneralizado3.pdf}
...
\begin{frame}[label={sec:orgdc9576d}]{Cálculo de corrientes}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CircuitoTrifasicaGeneralizado.pdf}
