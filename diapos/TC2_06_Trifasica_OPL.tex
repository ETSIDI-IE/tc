...
\section{Generadores}
\label{sec:org6d52a50}
\begin{frame}[label={sec:orgaa41f24}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org875586f}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc9e45f8}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org040c9db}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orge870fd2}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org08ea5b1}
\begin{frame}[label={sec:orgd33256b}]{Tipos de Receptores}
...
\begin{frame}[label={sec:org022a66d}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgde94cbb}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga850bfe}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2d21154}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org1d83d3b}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd245958}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:orgad9f61b}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgcf52753}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgb514538}]{Método del desplazamiento del neutro}
...
\end{frame}
\begin{frame}[label={sec:org6bc5754}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org044ad89}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:orgdb988bc}

\begin{frame}[label={sec:orgcdfdfcf}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgcace477}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org053ad04}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orga3fcdd5}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:orgcedeabf}

\begin{frame}[label={sec:org1d9f0a6}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7dddfe6}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org159f167}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgcdb7a40}
\begin{frame}[label={sec:org78dff73}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org4a9bcd6}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org78c58aa}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgec3ad89},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org6264786},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:orgd2e8ffa}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org21e0bd5}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge838bed}]{Medida de la reactiva con receptor desequilibrado}
\begin{center}
...
\label{sec:orgc57f687}

\begin{frame}[label={sec:org20e104d}]{Estrella a Triángulo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealEstrella.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org206db57}]{Transformamos impedancia}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org4ad860c}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_ZTriangulo.pdf}
...
\begin{frame}[label={sec:org24e6a2c}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_Transformado1.pdf}
...
\begin{frame}[label={sec:orga64eb59}]{Triángulo a Estrella}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealTriangulo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0cb2922}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org92290d2}]{Transformamos impedancias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I.pdf}
...
\begin{frame}[label={sec:orgd66cc7a}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I_ZEstrella.pdf}
...
\begin{frame}[label={sec:org9915176}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado1.pdf}
...
\begin{frame}[label={sec:org9c72d13}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado2.pdf}
...
\begin{frame}[label={sec:org89a6482}]{Estudio generalizado de los sistemas trifásicos}
\end{frame}
\end{document}