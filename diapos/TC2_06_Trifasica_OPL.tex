...
\section{Generadores}
\label{sec:org1595347}
\begin{frame}[label={sec:orgfd54253}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org8818990}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org300dfda}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:orgffc726b}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:orgfa5b194}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org6f609b1}
\begin{frame}[label={sec:org73d4384}]{Tipos de Receptores}
...
\begin{frame}[label={sec:orgc30eba6}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1826136}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc3c0527}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org64c8b06}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8533c80}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org5eb7a94}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge99f423}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:org2be17fe}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org22bf8f7}]{Método del desplazamiento del neutro}
...
\begin{align*}
  ...
  \overline{I}_B &= \frac{\overline{U}_{AN} - \overline{U}_{ON}}{\overline{Z}_B}\\
  \overline{I}_C &= \frac{\overline{U}_{AN} - \overline{U}_{ON}}{\overline{Z}_C}
\end{align*}
\end{frame}

\begin{frame}[label={sec:org70c68d0}]{Método del desplazamiento del neutro}
...
\begin{align*}
  ...
  \overline{I}_B &= (\overline{U}_{AN} - \overline{U}_{ON})\cdot{\overline{Y}_B}\\
  \overline{I}_C &= (\overline{U}_{AN} - \overline{U}_{ON})\cdot{\overline{Y}_C}
\end{align*}
\end{frame}

\begin{frame}[label={sec:org3862ee2}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgcdea11c}]{Transformación de receptores}
...
\begin{frame}[label={sec:orgb7f4c93}]{Transformación de receptores}
...
\label{sec:org9e798e2}

\begin{frame}[label={sec:org78e7f9e}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org27791d0}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org6bb9c64}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orge8d65bb}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:orgf16f9f4}

\begin{frame}[label={sec:org17d51a8}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9d5f6f6}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org46b260f}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org28f229b}
\begin{frame}[label={sec:org1af1122}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:orgb95d59d}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:org4be91e3}]{Sistema de 3 Hilos Equilibrado}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9f71fa8},plain]{Otras conexiones: 3H SFD}
\[
...
\begin{frame}[label={sec:org4fc009b},plain]{Otras conexiones: 3H SFI}
\[
...
\begin{frame}[label={sec:orgeb9ef3d}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org455adc4}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org53531e6}]{Medida de la reactiva con receptor desequilibrado}
\begin{center}
...
\label{sec:org7817b12}

\begin{frame}[label={sec:org8e8e8c8}]{Estrella a Triángulo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealEstrella.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org41459dc}]{Transformamos impedancia}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org74161d1}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_ZTriangulo.pdf}
...
\begin{frame}[label={sec:org07be415}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_Transformado1.pdf}
...
\begin{frame}[label={sec:orgf7c6102}]{Triángulo a Estrella}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealTriangulo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3b75bdc}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9dcefc8}]{Transformamos impedancias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I.pdf}
...
\begin{frame}[label={sec:org3654d5d}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I_ZEstrella.pdf}
...
\begin{frame}[label={sec:org7c95e49}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado1.pdf}
...
\begin{frame}[label={sec:org6be6a40}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado2.pdf}
...
\label{sec:orgdc8f9b0}
\begin{frame}[label={sec:org7640aa4}]{Planteamiento del sistema}
\begin{center}
...
\begin{frame}[label={sec:org7bc6423}]{Agrupamos impedancias de generador, línea y receptor}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd76d9c7}]{Conversión de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb65f69e}]{Tensión de desplazamiento del neutro}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CircuitoTrifasicaGeneralizado3.pdf}
...
\begin{frame}[label={sec:org1673bb8}]{Cálculo de corrientes}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CircuitoTrifasicaGeneralizado.pdf}
