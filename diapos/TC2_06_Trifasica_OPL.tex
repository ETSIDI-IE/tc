...
\section{Generadores}
\label{sec:orgbcdfeca}
\begin{frame}[label={sec:orgca89d21}]{Tensiones de Fase y Línea}
\begin{columns}
...
\begin{frame}[label={sec:org5948f9a}]{Tensiones de Fase y Línea}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgafba6ef}]{Secuencia de Fases}
\begin{itemize}
...
\begin{frame}[label={sec:org8a02de0}]{Secuencia de Fases Directa (SFD)}
\begin{center}
...
\begin{frame}[label={sec:org5e10708}]{Secuencia de Fases Inversa (SFI)}
\begin{center}
...
\end{frame}
\section{Receptores}
\label{sec:org4888a53}
\begin{frame}[label={sec:org987de51}]{Tipos de Receptores}
...
\begin{frame}[label={sec:orgd5c09d6}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcb5a938}]{Receptor en Estrella Equilibrado}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_SinNeutro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0efaa06}]{Receptor en Estrella con Carga Monofásica}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Estrella_CargaMonofasica.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga46cc56}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3013d3d}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org78e5cf0}]{Receptor en Estrella Desequilibrado con Neutro}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5a87217}]{Receptor en Estrella Desequilibrado sin Neutro}
\begin{center}
...
\begin{frame}[label={sec:org4448856}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:orgd6ea86e}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org8839c69}]{Método del desplazamiento del neutro}
...
\begin{frame}[label={sec:org3b6ff5b}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org22c9ed4}]{Transformación de receptores}
...
\begin{frame}[label={sec:org7eef4e5}]{Transformación de receptores}
...
\label{sec:org2b6f686}

\begin{frame}[label={sec:org9a60217}]{Receptor en Estrella Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org794771a}]{Receptor en Triángulo Equilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloEquilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:orgd56516d}]{Receptor en Estrella Desequilibrado}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstrellaDesequilibrado_Receptor.pdf}
...
\begin{frame}[label={sec:org2c0c48f}]{Receptor en Triángulo Desequilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/TrianguloDesequilibrado_Receptor.pdf}
...
\label{sec:org89b1ff3}

\begin{frame}[label={sec:orge485df5}]{Conexión en Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgca9669b}]{Conexión en Estrella}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge4481d3}]{Comparación Estrella-Triángulo}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org1e46462}
\begin{frame}[label={sec:orgaae957f}]{Recordatorio: vatímetro}
\begin{center}
...
\]
\end{frame}
\begin{frame}[label={sec:org3cd7b50}]{Sistema de 4 Hilos}
\begin{columns}
...
\begin{frame}[label={sec:orgd6c54ba}]{Sistema de 4 Hilos Equilibrado}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org350ea33},plain]{Sistema de 3 Hilos Equilibrado (SFD)}
\[
...
\begin{frame}[label={sec:orgada0003},plain]{Sistema de 3 Hilos Equilibrado (SFI)}
\[
...
\begin{frame}[label={sec:org414687a}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgca024dd}]{Conexiones para medida de reactiva}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc424a54}]{Medida de la reactiva con receptor desequilibrado}
\begin{center}
...
\label{sec:orgcb96e2e}

\begin{frame}[label={sec:orgd3d8db1}]{Estrella a Triángulo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealEstrella.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7dd4de3}]{Transformamos impedancia}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9e32125}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_ZTriangulo.pdf}
...
\begin{frame}[label={sec:org90040d2}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealEstrella_Transformado1.pdf}
...
\begin{frame}[label={sec:org0752af7}]{Triángulo a Estrella}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/GeneradorRealTriangulo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org164e406}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2d3cc9d}]{Transformamos impedancias}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I.pdf}
...
\begin{frame}[label={sec:org5cd586d}]{Aplicamos movilidad de fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_I_ZEstrella.pdf}
...
\begin{frame}[label={sec:orgca49137}]{Asociamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado1.pdf}
...
\begin{frame}[label={sec:orgeae2064}]{Transformamos fuentes}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/GeneradorRealTriangulo_Transformado2.pdf}
...
\label{sec:orgae76c5f}
\begin{frame}[label={sec:orgf7fd2b3}]{Planteamiento del sistema}
\begin{center}
...
\begin{frame}[label={sec:orgfce6a7e}]{Agrupamos impedancias de generador, línea y receptor}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org416502a}]{Conversión de fuentes}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org62b941e}]{Tensión de desplazamiento del neutro}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CircuitoTrifasicaGeneralizado3.pdf}
...
\begin{frame}[label={sec:org92d063d}]{Cálculo de corrientes}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CircuitoTrifasicaGeneralizado.pdf}
...
\begin{frame}[label={sec:org21e5560}]{Aplicación a sistemas equilibrados}
...
\begin{frame}[label={sec:org6e7cf25}]{Aplicación a sistemas desequilibrados}
\begin{itemize}
...
\begin{frame}[label={sec:org94544e9}]{Sistema sin neutro}
\begin{center}
...
\begin{frame}[label={sec:orgd41a92d}]{Receptor en triángulo}
\begin{center}
...
\begin{frame}[label={sec:org3e4ca89}]{Generador en triángulo}
\begin{center}
...
\begin{frame}[label={sec:org0d38ede}]{Generador y Receptor en triángulo}
\begin{center}
