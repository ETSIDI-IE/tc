...
\begin{circuitikz}
  ...
  to [short] (D);
  %% Corrientes de malla
  \draw[red,-latex] (2,2) node{$\overline{I}_a$} [partial ellipse=300:40:1cm and .45cm];
  \draw[red,-latex] (6,2) node{$\overline{I}_b$} [partial ellipse=300:40:1cm and .45cm];
  \draw[red,-latex] (4,-1) node{$\overline{I}_c$} [partial ellipse=300:40:1cm and .45cm];
\end{circuitikz}
