...
\emph{Sol.:$i(t) = 0.6 \cdot e^{-4t/9} + 2.4$.}
...
\emph{Sol.:$i_L(t) = 0.689 \cdot e^{-0.354 \cdot t} + 0.311 \cdot e^{-5.645 \cdot t}$;
$u_c(t) = 9.7275 \cdot e^{-0.354 \cdot t} + 0.275 \cdot e^{-5.645 \cdot t}$.}
