...
\begin{figure}
  \centering
  \subfloat[Potencia y eficiencia]{\includegraphics[height=6cm]{../figs/FuenteReal_PotenciaRendimiento.pdf}\label{fig:eficiencia-fuente}}\hspace{4cm}
    \subfloat[Variación de la potencia y eficiencia]{\includegraphics[height=6cm]{../figs/FuenteReal_DifPotencia.pdf}\label{fig:dif-eficiencia-fuente-tension}}
...
\end{enumerate}
	...
	\begin{example}\label{ex.nudos}
          \textbf{En el circuito de la Figura~\ref{fig:nudos_fuentes},
            ...
            \begin{itemize}
            \item Los potenciales en los nudos A y B
