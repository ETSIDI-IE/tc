...
\includegraphics[height=3.5cm]{../figs/ej7_BT1_sol.pdf}% 
	...
	\begin{example}\label{ex.ejemplo_mallas}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.4\linewidth]{../figs/ej5_BT1.pdf}
...
% 	\begin{figure}[H]
% 		\centering
% 		\subfloat[Escalón retrasado]{\includegraphics[width=.35\linewidth]{../figs/escalon_t0.pdf}}\hfil
% 		\subfloat[Pulso retrasado]{\includegraphics[width=.35\linewidth]{../figs/pulso_t0.pdf}}\\
% 		\subfloat[Rampa retrasada]{\includegraphics[width=.35\linewidth]{../figs/rampa_t0.pdf}}\hfil
% 		\subfloat[Triangular retrasada]{\includegraphics[width=.35\linewidth]{../figs/triangular_t0.pdf}}
...
\begin{remark}
    Los ejercicios 18 y 19 constituyen contenido avanzado.
\end{remark}
