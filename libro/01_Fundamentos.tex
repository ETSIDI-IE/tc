...
\end{align*}
% Uso "\rlap" porque, por alguna razón, "\Aboxed" mueve los resultados
% muy a la derecha. Idea para usar "\rlap" sacada de aquí:
% https://tex.stackexchange.com/questions/223511/aboxed-with-multiple-in-align-environment
...
%    \subsection{Teorema de superposición}
    ...
    \begin{figure}[H]
        ...
        \subfloat[Respuesta individual]{\includegraphics{../figs/superposicion2.pdf}}
