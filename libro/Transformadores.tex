...
% \begin{frame}[label={sec:org06465ee}]{Transformador Real de Varios
%   Devanados}
%   \begin{center}
...
% \begin{frame}[label={sec:orgdccada5}]{Ecuaciones del Transformador
%   Real}
%   \begin{center}
...
% \begin{frame}[label={sec:orge5dab44}]{Ecuaciones del Transformador
%   Perfecto}
%   \begin{center}
...
% \begin{frame}[label={sec:org04a7201}]{Relación de Transformación del
%   Transformador Ideal}
%   \begin{center}
...
%   \[
%     \overline{\phi}_{11} \pm \overline{\phi}_{22} \pm
%     \overline{\phi}_{33} = 0
%   \]
...
%   \[
%     \boxed{\overline{I}_1 = \mp 1/a_{12} \cdot \overline{I}_2 \mp
...
% Resultado:
% \[
%   \frac{\overline{I}_1}{\overline{U}_1} = \boxed{\overline{Y}_{in} =
...
% \begin{frame}[label={sec:org0ee8de8}]{Circuito Equivalente de un
...
% \begin{frame}[label={sec:orgd865c57}]{Circuito Equivalente de un
%   Transformador Perfecto}
%   \begin{columns}
%     \begin{column}{0.5\columnwidth}
%       \begin{center}
