...
\emph{Sol.:\; $\overline{Z} = \SI[parse-numbers=false]{138.5 - j\,3}{\ohm}$;\;
  $ \overline{I}_{AB} = {2.89\phase{121.24^\circ}}\,\unit{\ampere}$;\;
  $ \overline{I}_{BC} = {2.89\phase{1.24^\circ}}\,\unit{\ampere}$;\;
  $ \overline{I}_{CA} = {2.89\phase{-118.76^\circ}}\,\unit{\ampere}$;\;
  $ \overline{I}_A = {5\phase{91.24^\circ}}\,\unit{\ampere}$;\;
  $ \overline{I}_B = {5\phase{-28.76^\circ}}\,\unit{\ampere}$;\;
  $ \overline{I}_C = {5\phase{-148.76^\circ}}\,\unit{\ampere}$;\;
  $ W_a = W_c = \SI{1768.8}{\watt}$}
