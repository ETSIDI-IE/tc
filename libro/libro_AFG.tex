...
\node at (current page.north west)
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{Pictures/portada0.jpg}}; % Background image
...
% 	\begingroup
% 	\thispagestyle{empty}
% 	\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=2.1]{Pictures/portada0.png}}} % Image background
% 	\centering
% 	\vspace*{5.2cm}
...
% 	\endgroup
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Trayectoria]{\includegraphics[width=0.25\linewidth]{Pictures/diagrama_tension.PNG}\label{fig.diagrama_tension}}\hfil
		\subfigure[Sentido]{\includegraphics[width=0.25\linewidth]{Pictures/sentido_tension.pdf}\label{fig.sentido_tension}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[$P>0$]{\includegraphics[width=0.3\linewidth]{Pictures/signo_potencia1.pdf}}\hfil
		\subfigure[$P<0$]{\includegraphics[width=0.3\linewidth]{Pictures/signo_potencia2.pdf}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Receptor]{\includegraphics[width=0.25\linewidth]{Pictures/receptor_generador1.pdf}}\hfil
		\subfigure[Generador]{\includegraphics[width=0.25\linewidth]{Pictures/receptor_generador2.pdf}}
		\caption{Convenio de signos para la potencia}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Ideal]{\includegraphics[height=3.5cm]{Pictures/FuenteTensionIdealDC.pdf}}\hfil
		\subfigure[Real]{\includegraphics[height=3.5cm]{Pictures/FuenteTensionRealDC.pdf}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Ideal]{\includegraphics[height=3.5cm]{Pictures/FuenteCorrienteIdeal.pdf}}\hfil
		\subfigure[Real]{\includegraphics[height=3.5cm]{Pictures/FuenteCorrienteRealDC.pdf}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Fuente real de tensión]{\includegraphics[height=4.9cm]{Pictures/FuenteTensionRealDC.pdf}}\hfil
		\subfigure[Fuente real de corriente]{\includegraphics[height=4.9cm]{Pictures/FuenteCorrienteRealDC.pdf}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Tensión--Tensión]{\includegraphics[height=4cm]{Pictures/FuenteTensionDependienteTension.pdf}\label{fig.tension-tension}}\hfill
		\subfigure[Tensión--Corriente]{\includegraphics[height=4cm]{Pictures/FuenteTensionDependienteCorriente.pdf}\label{fig.tension-corriente}}\hfill
		\subfigure[Corriente--Tensión]{\includegraphics[height=4cm]{Pictures/FuenteCorrienteDependienteTension.pdf}\label{fig.corriente-tension}}\hfill
		\subfigure[Corriente--Corriente]{\includegraphics[height=4cm]{Pictures/FuenteCorrienteDependienteCorriente.pdf}\label{fig.corriente-corriente}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Referencia mediante signo]{\includegraphics{Pictures/Resistencia.pdf}}\hfil
		\subfigure[Referencia mediante flecha]{\includegraphics{Pictures/Resistencia_Flecha.pdf}}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Cortocircuito]{\includegraphics[width=0.2\linewidth]{Pictures/cortocircuito.pdf}\label{fig.cortocircuito}}\hfil
		\subfigure[Circuito abierto]{\includegraphics[width=0.2\linewidth]{Pictures/CircuitoAbierto.pdf}\label{fig.c_abierto}}
	...
	\begin{itemize}
		...
		\begin{figure}[htbp]
			\centering
			\subfigure[Ideal]{\includegraphics[height=3.5cm]{Pictures/receptor_ideal.pdf}}\hfil
			\subfigure[Real]{\includegraphics[height=3.5cm]{Pictures/receptor_real.pdf}}
			\caption{Receptores}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Conexión triángulo]{\includegraphics[width=0.3\linewidth]{Pictures/Conexion_Triangulo.pdf}}\hfil
		\subfigure[Conexión estrella]{\includegraphics[width=0.3\linewidth]{Pictures/Conexion_Estrella.pdf}}
