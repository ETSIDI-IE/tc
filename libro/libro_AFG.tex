...
\begin{figure}[htbp]
        \centering
        \subfigure[Red lineal]{\includegraphics[width=0.35\linewidth]{../figs/thevenin_continua_red.pdf}}\hfil
        \subfigure[Equivalente Thévenin]{\includegraphics[width=0.3\linewidth]{../figs/thevenin_continua.pdf}}
...
\begin{figure}[htbp]
        \centering
        \subfigure[Red lineal]{\includegraphics[width=0.35\linewidth]{../figs/thevenin_continua_red.pdf}}\hfil
        \subfigure[Equivalente Norton]{\includegraphics[width=0.3\linewidth]{../figs/norton_continua.pdf}\label{fig.norton1}}
...
\item FALTAN EJERCICIOS DE TEOREMAS
...
% \end{equation*}
	...
	\begin{example}\label{ex.2o_orden}
	    ...
	    \begin{figure}[H]
	        ...
	        \captionof{figure}{Ejemplo~\ref{ex.2o_orden}}
	    ...
	    \begin{figure}[H]
	        ...
	        \captionof{figure}{Circuito tras cerrar el interruptor}
