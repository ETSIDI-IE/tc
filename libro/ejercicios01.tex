...
\item Calcular las corrientes de malla mostradas en el circuito de la
  ...
  \end{figure}
  Datos: $R_1 = \qty{2}{\ohm}$; $R_2 = \qty{5}{\ohm}$; $R_3 = \qty{10}{\ohm}$, $R_4 = \qty{5}{\ohm}$; $E_1 = \qty{25}{\volt}$; $E_2 = \qty{50}{\volt}$

  \emph{Sol.: $I_1=-1.31$ A; $I_2=3.17$ A; $I_3=10.45$ A}
		
\item Calcular el valor de $E_1$ que hace que $I_0=7.5$ mA en el
...
\item En el circuito de la Figura~\ref{fig.ej12_BT1}, obtener las
  ...
  \end{figure}
    ...
    Datos: $R_1 = \qty{9}{\ohm}$; $R_2 = \qty{4}{\ohm}$; $R_3 = \qty{18}{\ohm}$; $R_4 = \qty{20}{\ohm}$; $R_5 = R_6 = \qty{20}{\ohm}$; $E_1 = \qty{16}{\volt}$; $I_g = \qty{2}{\ampere}$
...
\item Obtener el generador equivalente de Thévenin del circuito de la
  ...
  \item Determinar el equivalente Thévenin del circuito de la
    ...
    Datos: $R_1 = \qty{4}{\ohm}$; $R_2 = \qty{4}{\ohm}$; $R_3 = \qty{2}{\ohm}$; $E = \qty{10}{\volt}$; $I_g = \qty{8}{\ampere}$
