...
% 	donde $I_r$ \textbf{tiene signo contrario} al de $\theta$ de la impedancia.
	...
	\begin{example}\label{ej.2-7}
          \textbf{Sabiendo que las fuentes de tensión del circuito de
            ...
            las formas de onda
            $u_1(t)=10\sqrt{2}\cdot \cos(1000\cdot t)$ V y
            $u_2(t)=5\sqrt{2}\cdot \sin(1000\cdot t)$ V, calcular las
          ...
          Se pasa $u_1(t)$ a función senoidal, obteniéndose
          $u_1(t)=10\sqrt{2}\cdot \sin(1000\cdot
          t+\frac{\pi}{2})$. Así, los fasores de $\overline{U_1}$ y
          $\overline{U_2}$ son:
          \begin{align*}
