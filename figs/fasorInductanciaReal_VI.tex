...
\begin{tikzpicture}
  ...
  \draw [->, thin, color=burntumber](1.2,0)  arc[radius = 1.2, start angle= 0, end angle= 60] node [pos=0.2, left] {$\theta_U$};
  \draw [->, thin, color=black](30:1.4)  arc[radius = 1.4, start angle= 30, end angle= 60] node [pos=0.5, above] {$\varphi$};
  \draw[->, >=stealth, thick, color = burntumber] (0, 0) -- (60:2.5) node[above] {$\overline{U}$};
