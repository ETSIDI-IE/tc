...
\begin{circuitikz}[american voltages, american currents]
  ...
  \draw[red,-latex] (-.75,2) node{$\mathbf{I_{1A}}$} [partial ellipse=330:30:1cm and 1.5cm];
  \draw[red,-latex] (-.75,-6) node{$\mathbf{I_{1B}}$} [partial ellipse=30:330:1cm and 1.5cm];
  \draw[red,-latex] (8.75,2) node{$\mathbf{I_{2A}}$} [partial ellipse=30:330:1cm and 1.5cm];
  \draw[red,-latex] (8.75,-6) node{$\mathbf{I_{2B}}$} [partial ellipse=150:-150:1cm and 1.5cm];
\end{circuitikz}
\end{document}